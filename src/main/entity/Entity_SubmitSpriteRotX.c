/**
 * @brief Submits X-axis rotated sprite: GTE rotation on X before MVMVA transform
 * @note Original: func_80031F84 at 0x80031F84
 */
// Entity_SubmitSpriteRotX
...
void Entity_SubmitSpriteRotX(s32 *param_1,u8 *param_2,int param_3)

{
  ...
  GTE_LoadRotMatrixFromSVec(param_3,0x1f800000);
  GTE_LoadIdentityMatrix(&DAT_1f800020);
  Math_Atan2_2((int)*(s16 *)(param_3 + 6),&DAT_1f800020);
  GTE_MulMatrix3(0x1f800000,&DAT_1f800020);
  local_28 = (uint)*param_2;
  local_24 = (uint)param_2->flags;
  local_20 = (uint)param_2->kind;
