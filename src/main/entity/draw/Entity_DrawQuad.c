...
void FUN_800336dc(int param_1,s16 param_2,s16 param_3,u8 param_4)

{
  ...
  do {
    ...
    FUN_8007e1b8(&local_28,(&PTR_DAT_80017334)[(s16)(&DAT_800a235c)[iVar1 * 5]],
  ...
  do {
    ...
    FUN_8007e1b8(&local_28,(&PTR_DAT_80017334)[(u8)(&DAT_800a237c)[(s16)iVar1]],
                 *(s32 *)(param_1 + 4),&local_30);
    iVar1 = iVar1 + 1;
  ...
  do {
    ...
    FUN_8007e1b8(&local_28,(&PTR_DAT_80017334)[(u8)(&DAT_800a2390)[(s16)iVar1]],
                 *(s32 *)(param_1 + 4),&local_30);
    iVar1 = iVar1 + 1;
