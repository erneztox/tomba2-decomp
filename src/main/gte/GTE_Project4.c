/**
 * @brief GTE project variant 4: loads from _g_GTE_WorkF8, projects
...

{
  ...
  if (param_1->scale_y != 0) {
    ...
    if (bVar1) {
      ...
      _DAT_1f800088 = (_g_GTE_Work84 >> 8) * (int)param_1->velocity_y;
      _g_GTE_Work84 = (_g_GTE_Work84 >> 8) * (int)param_1->normal_x;
      _DAT_1f800090 = 0;
