...
void FUN_0000b9f8(undefined1 *param_1)
  ...
  if (bVar1 == 1) {
    ...
    if (5 < (byte)param_1[3] - 1) {
      ...
      halt_baddata();
                    ...
                    /* WARNING: Could not emulate address calculation at 0x0000bd8c */
    ...
    if (iVar3 == 0) {
      ...
      *(undefined4 *)(param_1 + 0x3c) = uVar2;
      ...
      if ((byte)param_1[3] - 1 < 6) {
                    /* WARNING: Could not emulate address calculation at 0x0000baf4 */
                    /* WARNING: Treating indirect jump as call */
