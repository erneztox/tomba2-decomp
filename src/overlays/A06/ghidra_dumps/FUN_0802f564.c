...
void FUN_0802f564(undefined1 *param_1)

{
  ...
  if (bVar1 == 1) {
    ...
    bVar1 = param_1[6];
    if (bVar1 == 1) {
      if ((DAT_800bfa4e == '\x02') && (DAT_800bfa48 == '\x01')) {
        func_0x00040cdc(param_1,0x8001b4dc,0x80147ddc);
        DAT_800bfa4e = 3;
                    /* WARNING: Bad instruction - Truncating control flow here */
        halt_baddata();
      }
      func_0x00040cdc(param_1,0x8001b4dc,0x80147e6c);
    ...
    if (bVar1 == 0) {
      iVar2 = func_0x000519e0(param_1,0xf,_DAT_800ecf94,0x80147d64);
      if (iVar2 != 0) {
        return;
      }
      ...
      *(undefined2 *)(param_1 + 0x86) = 0x90;
      ...
      func_0x00051b04(*(undefined4 *)(param_1 + 0xf0),0xf,0x14);
    }
  }
                    /* WARNING: Bad instruction - Truncating control flow here */
  halt_baddata();
