...
void FUN_801263a0(undefined4 param_1,undefined4 param_2,short *param_3,short *param_4)

{
  ...
  *(ushort *)(*(int *)(unaff_s3 + 0x62) + 8) = *(ushort *)(*(int *)(unaff_s3 + 0x62) + 8) & 0xfff;
  FUN_80131600();
  FUN_801314b4();
  FUN_8012e8a8();
  unaff_s3[0x37] = 0;
  ...
  unaff_s3[0x3d] = 0;
  FUN_80133444();
  if (*(byte *)((int)unaff_s3 + 3) < 3) {
    FUN_8013892c();
    if (*(byte *)((int)unaff_s3 + 3) < 2) {
      uVar1 = FUN_80125f50();
