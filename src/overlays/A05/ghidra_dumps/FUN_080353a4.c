...
void FUN_080353a4(int param_1,int param_2)

{
  ...
  *(int *)(iVar3 + 0xc0) = iVar2;
  if (iVar2 != 0) {
    iVar1 = param_2 * 0xe;
    *(undefined2 *)(iVar2 + 6) = *(undefined2 *)(iVar1 + -0x7fec0dc8);
    **(undefined2 **)(iVar3 + 0xc0) = *(undefined2 *)(iVar1 + -0x7fec0dc6);
    *(undefined2 *)(*(int *)(iVar3 + 0xc0) + 2) = *(undefined2 *)(iVar1 + -0x7fec0dc4);
    *(undefined2 *)(*(int *)(iVar3 + 0xc0) + 4) = *(undefined2 *)(iVar1 + -0x7fec0dc2);
