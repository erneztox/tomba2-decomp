...
void FUN_080199f4(int param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  if (iVar1 == 0) {
    ...
    func_0x0002847c(0x8011e9fc,*(undefined1 *)((*(byte *)(param_1 + 5) >> 1) + 0x8011eb2c),0);
    func_0x0002847c(0x8011e9b4,*(undefined1 *)((*(byte *)(param_1 + 6) >> 1) + 0x8011eb2c),0);
  }
  return;
}
