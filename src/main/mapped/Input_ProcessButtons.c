/**
 * @brief Processes button press events and dispatches actions
 * @note Original address: 0x80025934
 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void Input_ProcessButtons(int param_1,int param_2,undefined1 param_3)
