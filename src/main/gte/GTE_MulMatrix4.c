...
uint * GTE_MulMatrix4(s32 *param_1,uint *param_2)

{
  ...
  setCopReg(2,0,(uint)(u16)*param_2 | param_2->flags & 0xffff0000);
  setCopReg(2,0x800,param_2->sub_type);
  copFunction(2,0x486012);
  uVar1 = getCopReg(2,0x4800);
  iVar2 = getCopReg(2,0x5000);
  uVar3 = getCopReg(2,0x5800);
  setCopReg(2,0,(uint)*(u16 *)((int)param_2 + 2) | param_2->kind << 0x10);
  setCopReg(2,0x800,(int)(s16)*(u16 *)((int)param_2 + 0xe));
  copFunction(2,0x486012);
  iVar4 = getCopReg(2,0x4800);
  uVar5 = getCopReg(2,0x5000);
  iVar6 = getCopReg(2,0x5800);
  setCopReg(2,0,(uint)(u16)param_2->flags | param_2->kind & 0xffff0000);
