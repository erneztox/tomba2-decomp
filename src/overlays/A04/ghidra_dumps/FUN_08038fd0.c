...

{
  ...
  if (bVar1 == 1) {
    ...
    if ((DAT_800bf809 == '\0') && (DAT_1f800137 == '\0')) {
      ...
      *(ushort *)(param_1 + 0x4e) =
      ...
      if (*(byte *)(param_1 + 5) < 5) {
                    /* WARNING: Could not emulate address calculation at 0x0803914c */
  ...
  if (bVar1 < 2) {
    if (bVar1 == 0) {
      iVar4 = func_0x000519e0(param_1,0x10,_DAT_800ecfac,0x8014163c);
      uVar2 = _DAT_800ecfb0;
      if (iVar4 != 0) {
        return;
      }
      ...
      *(undefined2 *)(param_1 + 100) = 0x87;
      *(undefined2 *)(param_1 + 0x66) = 0x3c;
      *(undefined2 *)(param_1 + 0x74) = 0xf;
      *(undefined2 *)(param_1 + 0x72) = 0;
      *(undefined2 *)(param_1 + 0x76) = 0x12;
    ...
    if (*(byte *)(param_1 + 5) < 0xc) {
                    /* WARNING: Could not emulate address calculation at 0x0803922c */
                    /* WARNING: Treating indirect jump as call */
      (**(code **)((uint)*(byte *)(param_1 + 5) * 4 + -0x7fef5e18))();
      return;
    }
    *(undefined1 *)(param_1 + 0x29) = 0;
    *(undefined1 *)(param_1 + 0x5f) = 0;
