/**
 * @brief GTE project variant 2: loads matrix, projects, reads result
 * @note Original: func_8002DBE4 at 0x8002DBE4
 */
// GTE_Project2
...

{
  ...
  if (param_1->scale_y != 0) {
    ...
    if (!bVar1) {
      ...
      _DAT_1f800090 = (uint)param_1->sub_action << 4;
