...
#include "tomba.h"
void Entity_CollisionResponse(int param_1,int param_2)

{
  ...
  iVar5 = Entity_CalcAngle6(param_1,param_2);
  if (iVar5 == 0) {
    return;
  }
  ...
  iVar6 = Math_CosGTE(iVar5 >> 0x10);
  sVar1 = param_1->bounds_min_x;
  sVar2 = param_2->bounds_min_x;
  iVar5 = Math_Cos(iVar5 >> 0x10);
  ...
  cVar4 = Math_CompareAngle(iVar7,(int)param_1->draw_angle,1);
