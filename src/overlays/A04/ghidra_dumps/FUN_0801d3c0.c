...
void FUN_0801d3c0(int param_1,int param_2)

{
  ...
  pcVar4 = *(char **)(param_2 * 4 + -0x7febf8a0);
  ...
  if (*pcVar4 != -1) {
    ...
    do {
      if ((((pcVar3[-1] != '\x01') ||
        ...
        if ((byte)pcVar3[-2] < 0x1f) {
                    /* WARNING: Could not emulate address calculation at 0x0801d4e0 */
                    /* WARNING: Treating indirect jump as call */
          (**(code **)((uint)(byte)pcVar3[-2] * 4 + -0x7fef6318))();
          return;
        }
