...
LAB_8005e9dc:
  ...
  case 7:
    iVar3 = FUN_80055824();
    if (iVar3 == 0) {
      if (((((_g_InputState & 0x40) != 0) || (iVar3 = FUN_80076d68(param_1), iVar3 == 1)) ||
          (FUN_80055e28(param_1,0), (_g_InputState & 0x40) != 0)) || ((param_1->behavior_flags & 2) == 0)) {
        param_1[0x61] = 0;
        param_1->behavior_state = 0;
        param_1->action_state = 0;
        param_1->sub_action = 0;
