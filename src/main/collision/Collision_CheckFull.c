...

{
  ...
  if (_DAT_1f8001e0->kind != 0) {
    iVar6 = (int)(short)(uVar4 ^ 0x3f);
    do {
      if ((*_DAT_1f8001ec & 1) != 0) {
        if ((*_DAT_1f8001e0 & 8) == 0) {
          iVar2 = (int)(short)_DAT_1f8001ec->kind * ((int)_DAT_1f8001c2 - (int)(short)uVar4);
          ...
          uVar1 = _DAT_1f8001ec->flags;
          _DAT_1f8001a4 = (short)((int)(short)_DAT_1f8001ec->kind * (int)_DAT_1f8001c2 >> 6);
        }
    ...
    } while (iVar5 < (int)(uint)_DAT_1f8001e0->kind);
  }
  if (bVar3) {
    _DAT_1f8001a6 = 0;
    _DAT_1f8001a4 = 0;
