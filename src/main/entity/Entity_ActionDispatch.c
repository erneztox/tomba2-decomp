...
#include "tomba.h"
void Entity_ActionDispatch(int param_1,int param_2)
...
LAB_80058444:
    param_1->game_flags = bVar1;
    param_1->sprite_flags = bVar3;
    UI_DrawElement(uVar4,0x41);
    break;
  case 6:
    param_1->game_flags = param_1->game_flags | 4;
    Entity_State_Jump3(param_1,1);
    uVar4 = 0x49;
    goto LAB_80058494;
  case 7:
    param_1->game_flags = param_1->game_flags & 0xfb;
    Entity_State_Jump3(param_1,0);
    uVar4 = 0x4a;
LAB_80058494:
