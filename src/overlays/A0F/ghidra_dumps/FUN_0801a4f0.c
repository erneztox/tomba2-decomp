...
/* WARNING: Removing unreachable block (ram,0x0801a524) */
...

{
  ...
  if (bVar1 < 3) {
    ...
    *(short *)(param_1 + 0x48) = *(short *)(param_1 + 0x48) + *(short *)(param_1 + 0x54);
    *(short *)(param_1 + 0x4a) = *(short *)(param_1 + 0x4a) + *(short *)(param_1 + 0x58);
    *(short *)(param_1 + 0x4c) = *(short *)(param_1 + 0x4c) + *(short *)(param_1 + 0x5c);
  }
  else if (bVar1 == 3) {
