...
uint * FUN_0804313c(uint *param_1,int param_2,int param_3,int param_4)

{
  ...
  auStack_30[0] = 0x34808080;
  setCopReg(2,0x3000,auStack_30);
        ...
        if (0 < _DAT_1f800000) {
          ...
          if (((((ushort)puVar7[-5] < 0x140) || ((ushort)puVar7[-2] < 0x140)) ||
            ...
            *puVar7 = ((uint)param_1 & 0xf0f0f) << 4;
            ...
            if ((((uint)param_1 >> 0x18 & 4) == 0) || (_DAT_1f80009c == 0)) {
