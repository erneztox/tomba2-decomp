...
void FUN_08016f20(undefined1 *param_1)

{
  ...
  if (bVar1 == 1) {
    ...
    *(undefined2 *)(param_1 + 0x86) = 0x1a4;
    ...
    if ((byte)param_1[5] < 8) {
                    /* WARNING: Could not emulate address calculation at 0x080171e8 */
                    /* WARNING: Treating indirect jump as call */
      (**(code **)((uint)(byte)param_1[5] * 4 + -0x7fef6e88))();
      return;
    }
    if (param_1[1] != '\0') {
    ...
    if (bVar1 == 0) {
      if (param_1[5] == '\0') {
        iVar3 = func_0x000519e0(param_1,0x13,_DAT_800ecfa0,0x8011aadc);
        if (iVar3 != 0) {
          return;
        }
        *(undefined2 *)(param_1 + 0x80) = 100;
        ...
        *(undefined2 *)(param_1 + 0x40) = 0;
        ...
        if (iVar3 != 0) {
          *(undefined4 *)(iVar3 + 0x1c) = 0x8010de5c;
        ...
        *(undefined4 *)(param_1 + 0x3c) = _DAT_800ecfa4;
        _DAT_800bf864 = *(undefined4 *)(*(int *)(param_1 + 0xe4) + 0x40);
        *(undefined4 *)(*(int *)(param_1 + 0xe4) + 0x40) = 0;
        if ((DAT_800bfa1a & 8) == 0) {
          *param_1 = 8;
          param_1[0xbe] = 0;
          func_0x00040cdc(param_1,0x80125bcc,0x8011aa24);
          *(undefined4 *)(param_1 + 0x1c) = 0x801103ac;
          param_1[0x7b] = 0;
          param_1[5] = 0;
          func_0x00041718(param_1,0,0);
        }
        else {
          *(undefined4 *)(param_1 + 0x7c) = 0x80125bcc;
