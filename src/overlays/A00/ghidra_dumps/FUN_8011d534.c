...

{
  ...
  *(undefined2 *)(unaff_s0 + 0x2e) =
       *(undefined2 *)(*(int *)(iVar3 + *(short *)(unaff_s0 + 0x60) * 4 + 0xc0) + 0x2c);
  *(undefined2 *)(unaff_s0 + 0x32) =
       *(undefined2 *)(*(int *)(iVar3 + *(short *)(unaff_s0 + 0x60) * 4 + 0xc0) + 0x30);
  *(undefined2 *)(unaff_s0 + 0x36) =
       *(undefined2 *)(*(int *)(iVar3 + *(short *)(unaff_s0 + 0x60) * 4 + 0xc0) + 0x34);
