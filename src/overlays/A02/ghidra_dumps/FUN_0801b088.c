...

{
  ...
  uVar2 = *(undefined2 *)(*(int *)(param_1 + 0xc4) + 10);
  *(undefined2 *)(*(int *)(param_1 + 200) + 10) = uVar2;
  ...
  *(undefined2 *)(iVar4 + 10) = uVar2;
  ...
  if (bVar1 == 1) {
    if (DAT_800bf80f != '\0') {
      ...
      ;
      func_0x00051b04(*(int *)(param_1 + 0xcc),0xc,*(undefined2 *)(*(int *)(param_1 + 0xcc) + 0x38))
      ;
