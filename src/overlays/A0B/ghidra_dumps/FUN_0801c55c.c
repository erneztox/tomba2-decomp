...
void FUN_0801c55c(undefined1 *param_1)
  ...
  if (bVar1 == 1) {
    ...
    *(short *)(param_1 + 0x56) = *(short *)(param_1 + 0x56) + 0x40;
    ...
    if (1 < bVar1) {
      if (bVar1 == 2) {
        if ((byte)param_1[5] < 6) {
                    /* WARNING: Could not emulate address calculation at 0x0801c6d4 */
                    /* WARNING: Treating indirect jump as call */
          (**(code **)((uint)(byte)param_1[5] * 4 + -0x7fef6dd0))();
          return;
        }
      }
      else {
    ...
    if (bVar1 == 0) {
      iVar2 = func_0x000519e0(param_1,5,
                              *(undefined4 *)
                               (*(int *)((DAT_800bf870 - 10) * 4 + -0x7fedbdd8) * 4 + -0x7ff130a8),
                              0x80123eb8);
      if (iVar2 != 0) {
        return;
      }
      *(undefined4 *)(param_1 + 0x3c) =
           *(undefined4 *)(*(int *)((DAT_800bf870 - 10) * 4 + -0x7fedbdc4) * 4 + -0x7ff130a8);
