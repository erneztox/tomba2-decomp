// A0H_MaterialProcessor - Material/color processor

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void A0H_MaterialProcessor(int param_1)

{
  ...
  if (bVar1 != 0) {
    ...
    for (; puVar6 < (u16 *)(param_1 + (uint)bVar1 * 2 + 0x10); puVar6 = puVar6 + 1) {
      ...
      uVar5 = *puVar4;
      uVar3 = func_0x0010af58(puVar4 + 1,uVar2,uVar5 & 0xff);
      func_0x0010b240(uVar3,uVar2,uVar5 >> 0x10 & 0xff);
    }
  }
  return;
}
