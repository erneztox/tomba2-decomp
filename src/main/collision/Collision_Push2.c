...
#include "tomba.h"
s32 Collision_Push2(int param_1,s16 param_2,s16 param_3,s16 param_4)

{
  ...
  if (iVar2 != 0) {
    ...
    iVar2 = Collision_CheckMove(uVar5,0);
    if (iVar2 != 0) {
