...
LAB_80067148:
    ...
    iVar4 = (int)*(s16 *)(param_1 + 0x7a) - (int)param_1->pos_y;
    param_1->action_state = param_1->action_state + 1;
    if (iVar4 < 0) {
      iVar4 = iVar4 + 0x1f;
    }
    param_1->sprite_x = (s16)(iVar4 >> 5);
    iVar4 = (int)*(s16 *)(param_1 + 0x7c) - (int)*(s16 *)(param_1 + 0x32);
    if (iVar4 < 0) {
      iVar4 = iVar4 + 0x1f;
    }
    param_1->angle_offset = (s16)(iVar4 >> 5);
    iVar4 = (int)*(s16 *)(param_1 + 0x7e) - (int)param_1->pos_z;
    if (iVar4 < 0) {
      iVar4 = iVar4 + 0x1f;
    }
    param_1->sprite_y = (s16)(iVar4 >> 5);
    param_1[0x4a] = 0;
    param_1[0x4b] = 0xd0;
    param_1[0x40] = 0x22;
    param_1[0x41] = 0;
...
LAB_80067098:
  ...
  *param_1 = 6;
  ...
  param_1->sprite_x = (s16)(iVar4 >> 6);
  iVar4 = (int)*(s16 *)(param_1 + 0x7c) - (int)*(s16 *)(param_1 + 0x32);
  if (iVar4 < 0) {
    iVar4 = iVar4 + 0x3f;
  }
  param_1->angle_offset = (s16)(iVar4 >> 6);
  iVar4 = (int)*(s16 *)(param_1 + 0x7e) - (int)param_1->pos_z;
  if (iVar4 < 0) {
    iVar4 = iVar4 + 0x3f;
  }
  param_1->sprite_y = (s16)(iVar4 >> 6);
  param_1[0x4a] = 0;
  param_1[0x4b] = 0xc0;
  param_1[0x40] = 0x44;
  param_1[0x41] = 0;
