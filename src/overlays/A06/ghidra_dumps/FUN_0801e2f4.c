...
undefined4 FUN_0801e2f4(undefined1 *param_1)

{
  ...
  *(short *)(*(int *)(param_1 + 0xc4) + 2) =
       (short)((int)((int)*(short *)(*(int *)(param_1 + 0xc0) + 0x12) *
                    (uint)*(ushort *)(*(int *)(param_1 + 0xc0) + 0x3a)) >> 0xc);
  *(short *)(*(int *)(param_1 + 200) + 2) =
       *(short *)(*(int *)(param_1 + 0xc4) + 2) + *(short *)(*(int *)(param_1 + 0xc4) + 0x12);
  if (*(short *)(*(int *)(param_1 + 0xc0) + 0x3a) != 0) {
    return 0;
  }
