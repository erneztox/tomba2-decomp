...
undefined4 * FUN_80120420(undefined4 param_1,int param_2,int param_3)
...
LAB_80129614:
  ...
  unaff_s0[0xe] = 0;
  unaff_s0[0xf] = 0;
  puVar14 = *(ushort **)((uint)unaff_s0[3] * 4 + -0x7fec86dc);
  if (unaff_s0[0x47] != 3) {
    puVar14 = puVar14 + (uint)unaff_s0[0x47] * 0xb;
  }
  iVar11 = func_0x8007aae8();
  *(int *)(unaff_s0 + 0xc0) = iVar11;
  ...
  *(ushort *)(unaff_s0 + 0x88) = *puVar14;
  *(ushort *)(unaff_s0 + 0x8a) = puVar14[1];
  *(ushort *)(unaff_s0 + 0x8c) = puVar14[2];
  *(ushort *)(unaff_s0 + 0x54) = puVar14[3];
  *(ushort *)(unaff_s0 + 0x56) = puVar14[4];
  *(ushort *)(unaff_s0 + 0x58) = puVar14[5];
  *(ushort *)(*(int *)(unaff_s0 + 0xc0) + 0x3a) = puVar14[6];
  *(ushort *)(unaff_s0 + 0x80) = puVar14[7];
  *(ushort *)(unaff_s0 + 0x82) = puVar14[8];
  *(ushort *)(unaff_s0 + 0x84) = puVar14[9];
  bVar1 = unaff_s0[0x47];
  uVar10 = (uint)bVar1;
  *(ushort *)(unaff_s0 + 0x86) = puVar14[10];
  if (uVar10 == 2) {
    *(ushort *)(*(int *)(unaff_s0 + 0xc0) + 2) = *(ushort *)(*(int *)(unaff_s0 + 0xc0) + 0x3a) >> 1;
    ...
    if (uVar10 == 1) {
      *(undefined2 *)(*(int *)(unaff_s0 + 0xc0) + 2) = 0x140;
      *(ushort *)(unaff_s0 + 0x70) = *(short *)(*(int *)(unaff_s0 + 0xc0) + 0x3a) + puVar14[-5];
      goto LAB_80129614;
    }
    *(undefined2 *)(*(int *)(unaff_s0 + 0xc0) + 2) = 0x140;
  }
