...

{
  ...
  iVar3 = 0;
  *(undefined2 *)(param_1 + 0x2c) = *(undefined2 *)(_DAT_800e7f84 + 0x2c);
  *(undefined2 *)(param_1 + 0x2e) = *(undefined2 *)(_DAT_800e7f84 + 0x30);
  _DAT_1f800090 = (uint)*(byte *)(param_1 + 7) << 6;
  *(undefined2 *)(param_1 + 0x30) = *(undefined2 *)(_DAT_800e7f84 + 0x34);
  do {
    ...
    FUN_80027768(puVar1,0,0xffffff9c,*(undefined1 *)(param_1 + 0x29));
    iVar3 = iVar3 + 1;
  } while (iVar3 < 2);
  return;
}
