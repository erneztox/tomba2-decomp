...
#include "tomba.h"
s32 Entity_CalcAngle22(int param_1,int param_2,int param_3,s32 param_4)

{
  ...
  iVar8 = (int)(((uint)param_1->pos_z - (uint)*(u16 *)(param_3 + 0x34)) * 0x10000)
          >> 0x10;
  uVar6 = Math_SqrtGTE(iVar9 * iVar9 + iVar8 * iVar8);
  bVar4 = false;
  if (((int)(uVar6 & 0xffff) <= (int)param_1->bounds_min_x + (int)param_2->bounds_min_x)
    ...
    _g_AngleTarget = Math_Atan2(-iVar8,iVar9);
    bVar4 = true;
  }
  if (bVar4) {
    if (param_1->input_flags == '\x10') {
      ...
      if (bVar5 < 2) {
        iVar8 = Math_CosGTE(param_1->target_angle + 0x800);
        sVar1 = param_1->bounds_min_x;
        sVar2 = param_2->bounds_min_x;
        iVar9 = Math_Cos(param_1->target_angle + 0x800);
    ...
    uVar6 = Entity_InitFull(param_1,param_2,param_3,param_4);
    uVar7 = 1;
    if ((uVar6 & 0x80) == 0) {
      g_State182 = 0;
      uVar7 = 1;
