...
void FUN_08015334(int param_1,int param_2,int param_3)
  ...
  if ((ushort)((*(short *)(param_1 + 0x2e) - *(short *)(param_3 + 0x2c)) + 600U) < 0x259) {
    ...
    if (((int)((uint)*(ushort *)(param_2 + 0x80) + iVar7 & 0xffff) <=
      ...
      if (iVar4 << 0x10 <= iVar3 << 0x10) {
        ...
        else if ((iVar3 - *(short *)(param_1 + 0x84) <= iVar7 - (iVar6 + -0x40)) &&
                (*(short *)(param_1 + 0x4a) < 0)) {
          *(undefined1 *)(param_1 + 0x29) = 0x80;
          *(short *)(param_1 + 0x32) = *(short *)(param_1 + 0x84) + (sVar1 - ((short)iVar6 + -0x40))
          ;
        }
      }
    }
