...

{
  ...
  while( true ) {
    ...
    if (unaff_s5 == 0) break;
    func_0x00051b04(*(undefined4 *)(unaff_s0 + 0xc4));
    **(undefined2 **)(unaff_s0 + 0xc4) = *(undefined2 *)(unaff_s2 + 10);
    *(undefined2 *)(*(int *)(unaff_s0 + 0xc4) + 2) = *(undefined2 *)(unaff_s2 + 0xc);
    *(undefined2 *)(*(int *)(unaff_s0 + 0xc4) + 4) = *(undefined2 *)(unaff_s2 + 0xe);
    unaff_s0 = unaff_s0 + 4;
    unaff_s1 = unaff_s1 + 8;
    unaff_s2 = unaff_s2 + 8;
  }
