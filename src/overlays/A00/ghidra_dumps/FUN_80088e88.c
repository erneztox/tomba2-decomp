  ...
  if ((*(short *)(param_1 + 0xe6) == 0) || (*(int *)(param_1 + 0x28) == 0)) {
    if (((*(byte *)(param_1 + 0xe8) - 4 < 2) || (*(byte *)(param_1 + 0xe8) == 7)) &&
      ...
      if ((((**(byte **)(param_1 + 0x28) & 0xc0) == 0x40) &&
          (((*(byte **)(param_1 + 0x28))[1] & 1) != 0)) && (DAT_800abe80 + 10 < 0x3d)) {
        *(undefined1 *)(param_1 + 0x58) = 1;
        *(undefined1 *)(param_1 + 0x57) = 1;
        DAT_800abe80 = DAT_800abe80 + 10;
      }
    }
    else if (*(char *)(param_1 + 0xe8) == '\x03') {
      *(undefined1 *)(param_1 + 0x57) = 1;
    }
    else if (*(short *)(param_1 + 0xe6) == 0) {
      iVar10 = 5;
      param_1 = param_1 + 5;
      do {
        *(undefined1 *)(param_1 + 0x57) = 1;
    ...
    if (*(char *)(param_1 + 0xe9) != '\0') {
      ...
      do {
        bVar1 = false;
        bVar7 = 1;
        if (*(char *)(iVar10 + *(int *)(param_1 + 4) + 2) != '\0') {
          bVar7 = 0xff;
        }
        pbVar6 = (byte *)(param_1 + 0x5d);
        ...
        if ((bVar1) &&
           (iVar2 = DAT_800abe80 + (uint)*(byte *)(iVar10 + *(int *)(param_1 + 4) + 3), iVar2 < 0x3d
           )) {
          pbVar4 = (byte *)(param_1 + 0x5d);
          puVar5 = (undefined1 *)(param_1 + 0x57);
          iVar3 = 0;
          DAT_800abe80 = iVar2;
          if (uVar9 != 0) {
            do {
        ...
        uVar8 = uVar8 + 1;
        iVar10 = iVar10 + 5;
      } while ((int)uVar8 < (int)(uint)*(byte *)(param_1 + 0xe9));
    }
  }
  return;
}
