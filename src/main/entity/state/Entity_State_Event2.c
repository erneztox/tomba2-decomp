...
#include "tomba.h"
s32 Entity_State_Event2(int param_1)

{
  ...
  if (param_1->sub_state == '\0') {
    ...
    sVar1 = Math_Atan2((int)param_1->normal_z - (int)param_1->pos_z,
    ...
    *(u16 *)(param_1 + 100) = -sVar1 & 0xfff;
    uVar2 = Math_SqrtGTE(iVar4 * iVar4 + iVar6 * iVar6);
    ...
    *(s16 *)(param_1 + 100) = sVar1;
    ...
    if (*(s16 *)(param_1 + 0x76) < 0) {
      sVar3 = Math_Atan2((iVar4 * 0x10000 >> 0x10) - (int)param_1->normal_z,
