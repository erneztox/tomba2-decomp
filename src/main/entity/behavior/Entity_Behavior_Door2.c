...
#include "tomba.h"
void Entity_Behavior_Door2(int param_1)

{
  ...
  if (bVar1 != 1) {
    ...
    *(u16 *)(param_1 + 0x6e) =
    ...
    iVar3 = Math_Cos((int)*(s16 *)(param_1 + 0x6e));
    *(s16 *)(param_1 + 100) = (s16)(iVar3 * -6 >> 0xc);
    return;
  }
  param_1->flags = 1;
  Entity_DrawChild(param_1,param_1->draw_x);
...
LAB_800688bc:
  ...
  sVar2 = Math_Atan2(-iVar5,iVar3);
  uVar4 = *(s16 *)(param_1 + 0x70) + sVar2 & 0xfff;
  iVar3 = Math_SqrtGTE(iVar3 * iVar3 + iVar5 * iVar5);
  ...
  *(s16 *)(param_1 + 0x70) = sVar2;
  ...
  iVar3 = Math_CosGTE(uVar4);
  iVar5 = Math_Cos(uVar4);
...
LAB_800689e8:
  if (param_1->behavior_state == '\x01') {
    ...
    iVar3 = Math_Cos((int)param_1->type_flags);
