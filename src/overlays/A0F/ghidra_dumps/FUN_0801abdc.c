...
void FUN_0801abdc(int param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  if (iVar1 == 0) {
    ...
    func_0x0002847c(0x801207cc,*(undefined1 *)((*(byte *)(param_1 + 5) >> 1) + 0x8012086c),0);
    func_0x0002847c(0x80120784,*(undefined1 *)((*(byte *)(param_1 + 6) >> 1) + 0x8012086c),0);
  }
  return;
}
