/**
 * @brief Draws rotated 3D sprite with GTE rotation matrix + MVMVA
 * @note Original: func_8003C5F8 at 0x8003C5F8
 */
// Entity_Draw3DSpriteRotated
...
void Entity_Draw3DSpriteRotated(int param_1)

{
  ...
  if (param_1->anim_data != 0) {
    ...
    GTE_LoadRotationFromSVec(param_1 + 0x54,&DAT_1f800020);
