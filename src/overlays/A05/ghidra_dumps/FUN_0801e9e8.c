...
void FUN_0801e9e8(undefined1 *param_1)

{
  ...
  if (bVar1 != 1) {
    ...
    if (bVar1 == 0) {
      iVar2 = func_0x000519e0(param_1,0xf,_DAT_800ecfb0,0x8013b33c);
      if (iVar2 != 0) {
        return;
      }
      param_1[0xb] = 0;
  ...
  if (bVar1 == 1) {
    if (param_1[6] == '\0') {
      if (DAT_800bfa15 == '\x04') {
        func_0x00040d68(param_1,0x8013d2d4);
        param_1[0x70] = 2;
    ...
    if (param_1[6] == '\0') {
      ...
      if (param_1[0x70] == -1) {
        if (param_1[7] == '\0') {
          param_1[0x7a] = 0xd;
          func_0x00040d68(param_1,0x8013d35c);
          param_1[0x70] = 2;
