...
void FUN_80122508(undefined1 *param_1,uint param_2)

{
  ...
  *param_1 = (char)param_2;
  ...
  if ((byte)param_1[3] != param_2) {
    sVar2 = func_0x80085690(-((int)(((uint)*(ushort *)(unaff_s0 + 0x76) -
                                    (uint)*(ushort *)(unaff_s1 + 0x36)) * 0x10000) >> 0x10),0);
    uVar3 = func_0x80077768((int)sVar2,(int)*(short *)(unaff_s1 + 0x140),0);
    *(undefined2 *)(unaff_s0 + 0x72) = uVar3;
    sVar2 = *(short *)(unaff_s0 + 0x76) - *(short *)(unaff_s2 + 2);
