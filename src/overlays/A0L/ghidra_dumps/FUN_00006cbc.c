...

{
  ...
  if (bVar1 == 1) {
    ...
    if (bVar1 == 0) {
      iVar3 = func_0x000519e0(param_1,0x11,_DAT_800ecfac,0x801174a0);
      if (iVar3 != 0) {
        return;
      }
      *(undefined4 *)(param_1 + 0x3c) = _DAT_800ecfe4;
      func_0x00077c40(param_1,0x8011aeac,1);
