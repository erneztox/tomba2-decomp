...
void FUN_000022b0(undefined1 *param_1)
  ...
  if (bVar1 == 1) {
    if (0x13 < (byte)param_1[3]) {
      ...
      halt_baddata();
                    ...
                    /* WARNING: Could not emulate address calculation at 0x00002614 */
    ...
    if (iVar4 == 0) {
      ...
      *(undefined2 *)(param_1 + 0x5a) = *(undefined2 *)(param_1 + 0x56);
      ...
      if ((byte)param_1[3] < 0x14) {
                    /* WARNING: Could not emulate address calculation at 0x00002494 */
                    /* WARNING: Treating indirect jump as call */
