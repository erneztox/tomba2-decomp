...
#include "tomba.h"
void FUN_8007c3cc(s32 param_1,s16 *param_2,u8 param_3,uint param_4)

{
  ...
  psVar3 = (s16 *)FUN_8007c2a4(param_1,param_2,param_3,(uVar4 / 0x708) % 10,uVar1);
  sVar2 = *param_2;
  ...
  *psVar3 = sVar2;
  psVar3->kind = 0x38;
  *param_2 = *param_2 + 8;
  psVar3 = (s16 *)FUN_8007c2a4(psVar3 + 4,param_2,param_3,(uVar4 / 0x1e) % 0x3c,uVar1);
  sVar2 = *param_2;
  psVar3->flags = param_3;
  *(u8 *)((int)psVar3 + 3) = uVar1;
  psVar3->kind = 0x10;
