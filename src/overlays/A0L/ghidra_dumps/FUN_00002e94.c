  ...
  if (DAT_800bf871 == 1) {
    ...
    do {
      ...
      do {
        ...
        puVar15 = puVar16 + 4;
        puVar12[6] = (uVar10 & 0xfff0) + ((int)((0x98 - (uint)uVar1) * 0x10000) >> 0x10) & 0xffff |
      ...
      uVar11 = uVar11 + 0x10;
    } while ((int)(uVar11 * 0x10000) >> 0x10 < (short)uVar7 + 0x100);
