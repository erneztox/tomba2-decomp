...

{
  ...
  while (DAT_1f800182 != '\0') {
    ...
    if (((((*pbVar2 & 1) != 0) && (pbVar2[0xc] == 9)) &&
        ((pbVar2[2] == 0x17 || (pbVar2[2] == 0x3d)))) &&
       (iVar1 = func_0x0002300c(&DAT_800e7e80,pbVar2,*(short *)(pbVar2 + 0x80) * 3), iVar1 != 0)) {
      DAT_1f800182 = '\0';
  ...
  if (_DAT_1f800080 == (byte *)0x0) {
    while (DAT_1f800182 != '\0') {
      ...
      DAT_1f800182 = DAT_1f800182 + -1;
      puVar3 = puVar3 + 1;
      if ((((*pbVar2 & 1) != 0) && (pbVar2[2] == 0x33)) &&
         (iVar1 = func_0x0002300c(&DAT_800e7e80,pbVar2,(int)*(short *)(pbVar2 + 0x80)), iVar1 != 0))
      {
        DAT_1f800182 = '\0';
        _DAT_1f800080 = pbVar2;
        pbVar2[0x2b] = 2;
