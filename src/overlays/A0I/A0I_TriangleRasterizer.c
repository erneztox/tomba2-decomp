// A0I_TriangleRasterizer - Triangle rasterizer: scanline fill with screen bounds

/* WARNING: Control flow encountered bad instruction data */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void A0I_TriangleRasterizer(int param_1,short *param_2,short *param_3,short *param_4)

{
  ...
  iVar3 = (int)param_2->flags;
  iVar7 = (int)param_3->flags;
  iVar8 = (int)param_4->flags;
