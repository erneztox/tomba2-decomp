...
undefined4 FUN_08010b50(int param_1,int param_2,int param_3)

{
  ...
  iVar1 = func_0x00083e80((int)*(short *)(param_3 + 0xc));
  iVar2 = func_0x00083e80((int)*(short *)(param_2 + 0x56));
  ...
  if ((int)(uVar3 & 0xffff) <= *(short *)(param_2 + 0x80) + _DAT_1f800088) {
    iVar1 = func_0x00083f50((int)*(short *)(param_3 + 0xc));
    uVar4 = 0;
