...
void FUN_0801bd5c(int param_1,int param_2)

{
  ...
  pcVar4 = *(char **)(param_2 * 4 + -0x7febe198);
  ...
  if (*pcVar4 != -1) {
    ...
    do {
      if ((((pcVar3[-1] != '\x01') ||
        ...
        if ((byte)pcVar3[-2] < 0x1b) {
                    /* WARNING: Could not emulate address calculation at 0x0801bea8 */
                    /* WARNING: Treating indirect jump as call */
          (**(code **)((uint)(byte)pcVar3[-2] * 4 + -0x7fef6864))();
          return;
        }
