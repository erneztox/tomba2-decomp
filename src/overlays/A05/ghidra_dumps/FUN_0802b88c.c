...
void FUN_0802b88c(undefined1 *param_1)

{
  ...
  if (bVar1 == 1) {
    ...
    *(int *)(param_1 + 0x30) = *(int *)(param_1 + 0x30) + sVar2 * 0x100;
    ...
    if (bVar1 == 0) {
      param_1[6] = 1;
      *(undefined2 *)(param_1 + 0x4a) = 0xda00;
      *(undefined2 *)(param_1 + 0x50) = 0x200;
      uVar6 = func_0x00077768((uint)(byte)param_1[0x2b] << 4,(int)*(short *)(param_1 + 0x60),0);
      param_1[0xbe] = uVar6;
      if (param_1[2] == 'B') {
        *(undefined2 *)(param_1 + 0x44) = 0x6c0;
