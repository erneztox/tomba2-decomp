...
uint * FUN_80115dd0(undefined4 param_1,undefined4 param_2,int param_3,int param_4)

{
  ...
  *(char *)(unaff_s0 + 5) = (char)unaff_s2;
  if ((((*(char *)(unaff_s0 + 1) == '\0') || (DAT_1f800207 != '\x10')) || (_DAT_1f800164 < 0x399e))
     || (iVar4 = func_0x8005308c(), iVar4 == 0)) {
    func_0x80041098();
