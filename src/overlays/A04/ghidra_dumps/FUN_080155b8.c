...
undefined4 FUN_080155b8(int param_1,int param_2)

{
  ...
  iVar8 = (int)(((uint)*(ushort *)(param_1 + 0x2e) - (uint)*(ushort *)(param_2 + 0x2e)) * 0x10000)
          >> 0x10;
  iVar7 = (int)(((uint)*(ushort *)(param_1 + 0x36) - (uint)*(ushort *)(param_2 + 0x36)) * 0x10000)
          >> 0x10;
  uVar5 = func_0x00084080(iVar8 * iVar8 + iVar7 * iVar7);
  uVar6 = 0;
  if (((int)(uVar5 & 0xffff) <= (int)*(short *)(param_1 + 0x80) + (int)*(short *)(param_2 + 0x80))
    ...
    _DAT_1f80009c = func_0x00085690(-iVar7,iVar8);
    if (*(char *)(param_1 + 0xc) == '\x02') {
      cVar4 = func_0x00077768((int)_DAT_1f80009c,(int)*(short *)(param_1 + 0x60),1);
