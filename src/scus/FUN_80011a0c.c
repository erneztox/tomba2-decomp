...

{
  ...
  FUN_8001de3c(0x20000);
  FUN_8001e00c(1);
  FUN_80015e0c(0x8001fb5c);
  FUN_80015e1c(&stack0x00000040);
  FUN_800134f4(in_stack_0000004c,in_stack_00000050);
  if ((in_stack_00000040 & 8) != 0) {
    FUN_800134f4(in_stack_00000044,in_stack_00000048);
  }
  FUN_80013248(0);
  func_0x80010d54();
  FUN_80011a0c();
