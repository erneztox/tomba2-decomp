...
void FUN_80122ea0(undefined4 param_1,undefined4 param_2,int param_3,int param_4)

{
  ...
  *(char *)((int)unaff_s2 + 0x5f) = *(char *)((int)unaff_s2 + 0x5f) + -1;
  uVar4 = unaff_s2[0x30];
  *(short *)(uVar4 + 10) = *(short *)(uVar4 + 10) + *(short *)(uVar4 + 0x16);
  *(short *)(unaff_s1 + 0x3e) = *(short *)(unaff_s1 + 0x3e) + 0x10;
  uVar4 = unaff_s2[0x10];
  *(short *)(unaff_s2 + 0x10) = (short)uVar4 + -1;
  if ((short)uVar4 == 1) {
    iVar8 = -0x7feb5dcc;
    *(char *)((int)unaff_s2 + 5) = *(char *)((int)unaff_s2 + 5) + '\x01';
    DAT_800bf9de = 0x13;
    uVar12 = func_0x8006cbd0();
    do {
      ...
      uVar12 = CONCAT44(uVar4,*(undefined4 *)(iVar8 + param_3 + 0xc0));
    } while( true );
  }
  return;
}
