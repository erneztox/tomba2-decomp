...

{
  ...
  if (iVar3 != 0) {
    ...
    if (iVar1 == 0) {
      _DAT_1f800088 = *(short *)(param_1 + 0x56) * _DAT_1f800084 >> 8;
      _DAT_1f800084 = *(short *)(param_1 + 0x54) * _DAT_1f800084 >> 8;
      _DAT_1f800090 = func_0x0009a450();
      _DAT_1f800090 = _DAT_1f800090 & 0x1ff;
      uVar2 = func_0x00027a4c(iVar3,_DAT_8011bfb0);
      if (DAT_800bf809 == '\0') {
