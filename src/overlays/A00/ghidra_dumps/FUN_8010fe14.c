...
void FUN_8010fe14(undefined1 *param_1)

{
  ...
  if (bVar1 == 1) {
    ...
    if (*(char *)(iVar3 + 0x5e) == '\0') {
      param_1[5] = 2;
      *param_1 = 1;
      *(undefined4 *)(param_1 + 0x10) = *(undefined4 *)(iVar3 + *(short *)(iVar3 + 0x6c) * 4 + 0xc0)
      ;
      FUN_80118f28();
      return;
    }
    ...
    if (bVar1 < 2) {
      ...
      param_1[5] = 1;
      param_1[0x47] = *(undefined1 *)(*(int *)(param_1 + 0x10) + 0x5e);
      FUN_80118f28();
      return;
    }
    if (bVar1 != 2) {
    ...
    if (bVar1 == 1) {
      ...
      *(short *)(param_1 + 0x4a) = *(short *)(param_1 + 0x4a) + *(short *)(param_1 + 0x50);
      ...
      param_1[6] = 1;
      param_1[0x2a] = *(undefined1 *)(*(short *)(param_1 + 0x40) + -0x7feb7a10);
