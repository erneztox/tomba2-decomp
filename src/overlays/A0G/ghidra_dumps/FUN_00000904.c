...

{
  ...
  if (DAT_800e7e80 < 8) {
                    /* WARNING: Could not emulate address calculation at 0x00000950 */
  ...
  if (_DAT_800e7fd8 < 2) {
    while (DAT_1f800182 = cVar1, DAT_1f800182 != '\0') {
      ...
      if (((*pbVar3 & 1) != 0) && (uVar2 = pbVar3[2] - 0xc, uVar2 < 0x14)) {
                    /* WARNING: Could not emulate address calculation at 0x00000b5c */
                    /* WARNING: Treating indirect jump as call */
