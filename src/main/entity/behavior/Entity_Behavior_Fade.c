...
LAB_8002608c:
  if (0 < (int)(*(u8 *)(param_1 + 0x15) - 1)) {
    ...
    iVar4 = 1;
    do {
      *(u8 *)(param_1 + iVar2 + 0x16) = *(u8 *)(param_1 + iVar4 + 0x16);
      *(u8 *)(param_1 + iVar2 + 0x1c) = *(u8 *)(param_1 + iVar4 + 0x1c);
      bVar1 = iVar4 < (int)(*(u8 *)(param_1 + 0x15) - 1);
      iVar2 = iVar4;
      iVar4 = iVar4 + 1;
    } while (bVar1);
  }
  *(s8*)(param_1 + 0x15) = *(s8*)(param_1 + 0x15) + -1;
  *(s8*)(param_1 + 0x14) = *(s8*)(param_1 + 0x14) + '\x01';
  return;
}
