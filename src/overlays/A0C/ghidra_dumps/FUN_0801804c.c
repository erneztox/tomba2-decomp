...
void FUN_0801804c(undefined1 *param_1)

{
  ...
  if (bVar1 == 1) {
    ...
    *(undefined2 *)(param_1 + 0x86) = 0x10e;
    ...
    if ((byte)param_1[5] < 8) {
                    /* WARNING: Could not emulate address calculation at 0x08018300 */
                    /* WARNING: Treating indirect jump as call */
      (**(code **)((uint)(byte)param_1[5] * 4 + -0x7fef6e4c))();
      return;
    }
    if (param_1[1] != '\0') {
    ...
    if (bVar1 == 0) {
      if (param_1[5] == '\0') {
        iVar3 = func_0x000519e0(param_1,0x12,_DAT_800ecfa0,0x8011c0ac);
        if (iVar3 != 0) {
          return;
        }
        *(undefined2 *)(param_1 + 0x80) = 0x5a;
        ...
        *(undefined2 *)(param_1 + 0x40) = 0;
        ...
        if (iVar3 != 0) {
          *(undefined4 *)(iVar3 + 0x1c) = 0x80110208;
        ...
        *(undefined4 *)(param_1 + 0x3c) = _DAT_800ecfa4;
        ...
        if ((DAT_800bfa1a & 4) == 0) {
          *param_1 = 8;
          param_1[0xbe] = 0;
          *(undefined2 *)(param_1 + 0x56) = 0x5b4;
          param_1[0x7b] = 0;
          func_0x00040cdc(param_1,0x80126cd8,0x8011bfc4);
          *(undefined4 *)(param_1 + 0x1c) = 0x801114c4;
          param_1[5] = 0;
          func_0x00041718(param_1,0,0);
        }
        else {
          *(undefined4 *)(param_1 + 0x7c) = 0x80126cd8;
