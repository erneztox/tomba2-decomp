...
uint * FUN_0801a214(uint *param_1,undefined4 param_2,int param_3)

{
  ...
  if (param_3 != 0) {
    puVar8 = param_1 + 10;
    puVar7 = (ushort *)(_DAT_800bf544 + 0x2e);
    do {
      iVar10 = param_3 + -1;
            ...
            *(undefined4 *)(iVar3 + 0x2c) = uVar2;
            if (((((*(ushort *)(iVar3 + 8) < 0x140) || (*(ushort *)(iVar3 + 0x14) < 0x140)) ||
               ...
               (((*(ushort *)(iVar3 + 10) < 0xf0 || (*(ushort *)(iVar3 + 0x16) < 0xf0)) ||
                ((*(ushort *)(iVar3 + 0x22) < 0xf0 || (*puVar7 < 0xf0)))))) {
              uVar5 = uVar5 >> 0x18 & 3;
              if (uVar5 == 1) {
