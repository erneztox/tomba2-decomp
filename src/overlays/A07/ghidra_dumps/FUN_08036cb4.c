...
/* WARNING: Removing unreachable block (ram,0x08036e00) */

undefined4 FUN_08036cb4(int param_1)

{
  ...
  if (bVar1 != 1) {
    ...
    iVar8 = (uint)*(ushort *)(param_1 + 0x76) - (uint)*(ushort *)(param_1 + 0x36);
...
LAB_08036eac:
  ...
  *(short *)(param_1 + 0x2e) = *(short *)(iVar9 + 4) - (short)(iVar5 >> 0xc);
  if (iVar6 < 0) {
    iVar6 = iVar6 + 0xfff;
  }
  *(short *)(param_1 + 0x36) = *(short *)(iVar9 + 6) - (short)(iVar6 >> 0xc);
  func_0x00130e20(param_1,0);
  iVar9 = func_0x00130f50(param_1);
  if (iVar9 == 0) {
    ...
    *(int *)(param_1 + 0x30) = *(int *)(param_1 + 0x30) + *(short *)(param_1 + 0x50) * 0x100;
    if (*(short *)(param_1 + 0x44) == 0) {
      ...
      if ((*(char *)(param_1 + 0x7b) != -1) &&
         (uVar7 = 1, ((int)*(short *)(param_1 + 0x72) & 0x8000U) == 0)) {
