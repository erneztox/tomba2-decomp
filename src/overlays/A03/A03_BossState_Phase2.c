// A03_BossState_Phase2 - Boss state machine: large GTE operations, phase 2

/* WARNING: Control flow encountered bad instruction data */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void A03_BossState_Phase2(int param_1)

{
  ...
  *(short *)(param_1 + 0x70) = *(short *)(param_1 + 0x70) + 0x44;
  ...
  if (-1 < (int)((uint)(uVar1 ^ *(u16 *)(param_1 + 0x6e)) << 0x10)) {
    *(u16 *)(param_1 + 0x70) = uVar1 - (short)((short)uVar1 * 3 >> 3);
  }
  if (local_84 < 0) {
    Math_Cos(local_84 >> 0x12);
                    /* WARNING: Bad instruction - Truncating control flow here */
    halt_baddata();
  }
  iVar6 = Math_Cos(local_84 >> 0x12);
