...

{
  ...
  if (in_v1 != 0) {
    ...
    in_stack_00000010._2_2_ = *(undefined2 *)(iVar4 + 0x2c);
    in_stack_00000014._2_2_ = *(undefined2 *)(iVar4 + 0x30);
    in_stack_00000018._2_2_ = *(undefined2 *)(iVar4 + 0x34);
