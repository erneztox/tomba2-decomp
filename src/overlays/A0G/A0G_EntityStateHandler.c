// A0G_EntityStateHandler - Entity state machine: action dispatch, health check

/* WARNING: Control flow encountered bad instruction data */
/* WARNING: Removing unreachable block (ram,0x08011e14) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void A0G_EntityStateHandler(int param_1)

{
  ...
  if (bVar1 == 1) {
    ...
    if (bVar1 == 0) {
      if (_DAT_800bf850 == 0) {
        if (((param_1->collision_state != '\0') && (DAT_800e7ea9 != '\0')) &&
           (DAT_800e7ffb == '\0')) {
          DAT_1f800137 = 2;
          param_1->flag_5E = 2;
          halt_baddata();
