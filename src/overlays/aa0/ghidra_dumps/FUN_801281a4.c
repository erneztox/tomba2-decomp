...
uint FUN_801281a4(undefined4 param_1,undefined4 param_2,int param_3)

{
  ...
  uVar4 = 0;
  if (in_v0 < 2) {
    uVar4 = (uint)*(ushort *)(param_3 + 0x7a);
    puVar6 = (undefined2 *)(uVar4 & 3);
    if (((*(ushort *)(param_3 + 0x7a) & 3) != 0) &&
       (bVar1 = *(byte *)(*(int *)(param_3 + (int)puVar6 * 4 + 0xc0) + 0x3e), uVar4 = bVar1 & 3,
       (bVar1 & 3) == 0)) {
...
LAB_80131278:
      ...
      *(undefined2 *)(param_3 + 0x72) = uVar3;
      uVar4 = *(ushort *)(param_3 + 0x7a) & 4;
      if ((*(ushort *)(param_3 + 0x7a) & 4) != 0) {
        uVar4 = *(ushort *)(param_3 + 0x72) + 2;
        *(short *)(param_3 + 0x72) = (short)uVar4;
      }
    }
  }
  return uVar4;
