/**
 * @brief Audio voice set variant 6: stores voice params, different byte layout
...
void FUN_8008f360(short param_1,short param_2,short param_3,undefined4 param_4)
