...
#include "tomba.h"
void GTE_ProjectEntity(int param_1)

{
  ...
  if (param_1->counter1 != '\0') {
    ...
    do {
      ...
      Math_Atan2_3((int)*(s16 *)(iVar2 + 8),0x1f800000);
      GTE_RotateVectorY((int)*(s16 *)(iVar2 + 0xc),0x1f800000);
      Math_Atan2_2((int)*(s16 *)(iVar2 + 10),0x1f800000);
      if (sVar1 == -1) {
        GTE_ComposeMatrix(param_1 + 0x98,0x1f800000,iVar2 + 0x18);
        GTE_MulMatrix(iVar2,iVar2 + 0x2c);
        *(int *)(iVar2 + 0x2c) = *(int *)(iVar2 + 0x2c) + param_1->projected_x;
        ...
        GTE_ComposeMatrix(iVar3->sprite_ptr1 + 0x18,0x1f800000,iVar2 + 0x18);
        GTE_MulMatrix(iVar2,iVar2 + 0x2c);
