...

{
  ...
  *(short *)(param_1 + 0xc) = in_v0 - in_v1;
  *(short *)(*(int *)(unaff_s0 + 0xc0) + 0x38) = *(short *)(*(int *)(unaff_s0 + 0xc0) + 0x38) + -2;
  ...
  if (iVar4 != 0) {
    if (*(short *)(unaff_s1 + 0x42) != 0) {
      ...
      *(undefined1 *)(*(int *)(unaff_s0 + 0xc0) + 0x3f) = 4;
      FUN_80137ab4();
      return;
    }
    FUN_80137a6c();
