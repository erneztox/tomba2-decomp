/**
 * @brief CD init params: sets 0x800AC280-2B8 defaults (mode, speed, filter)
 * @note Original: func_8008B620 at 0x8008B620
 */
// CD_InitParams



s32 CD_InitParams(s32 param_1,uint param_2)
