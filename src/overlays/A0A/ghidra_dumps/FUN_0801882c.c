  ...
  if (iVar4 == 0) {
    ...
    do {
      ...
      local_2c = CONCAT22(local_2c._2_2_,
                          *(short *)(param_1 + 0x30) +
                          (short)((int)(iVar6 * (uint)pbVar8[1] * iVar9) >> 0x13));
      iVar6 = func_0x00083e80(iVar9);
      local_30 = CONCAT22(*(short *)(param_1 + 0x2e) - (short)(iVar6 * (uint)*pbVar8 >> 8),
                          sVar2 + (short)((int)(iVar5 * (uint)bVar1 * iVar9) >> 0x13));
