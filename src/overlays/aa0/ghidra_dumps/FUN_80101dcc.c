...
void FUN_80101dcc(int param_1,int param_2)

{
  ...
  iVar2 = func_0x80083f50((int)*(short *)(iVar5 + 0xc));
  *(short *)(param_1 + 0x32) =
       *(short *)(iVar5 + 0x30) + (short)(iVar2 * *(short *)(param_1 + 0x156) >> 0xc);
  iVar2 = func_0x80083f50((int)*(short *)(param_1 + 0x58));
  *(short *)(param_1 + 0x32) =
       *(short *)(param_1 + 0x32) + (short)(iVar2 * *(short *)(param_1 + 100) >> 0xc);
  iVar2 = func_0x80083e80((int)*(short *)(iVar5 + 0xc));
  ...
  *(short *)(param_1 + 0x36) = *(short *)(iVar5 + 0x34) + (short)(iVar3 * iVar4 >> 0xc);
  iVar2 = func_0x80083e80((int)*(short *)(param_1 + 0x58));
