...
uint * FUN_80115d84(int param_1,undefined4 param_2,int param_3,int param_4)

{
  ...
  uVar4 = 2;
  uVar10 = (undefined1)unaff_s2;
  if (in_v1 < 2) {
    if (in_v1 == 0) {
      param_1 = unaff_s0;
      func_0x8007778c();
      uVar4 = (ushort)DAT_800bf8bf;
      if (DAT_800bf8bf == 0) {
        if ((((*(char *)(unaff_s0 + 1) == '\0') || (DAT_1f800207 != '\x10')) ||
            (_DAT_1f800164 < 0x399e)) || (iVar9 = func_0x8005308c(), iVar9 == 0)) goto LAB_80115f00;
        func_0x80042354(1,1);
        param_1 = unaff_s0;
        func_0x80040d68();
        uVar4 = 2;
    ...
    if (in_v1 == 2) {
      ...
      *(undefined1 *)(unaff_s0 + 1) = uVar10;
      func_0x80077e7c();
LAB_80115f00:
      func_0x80041098();
      puVar5 = (uint *)func_0x8004190c();
      return puVar5;
    }
  }
  *(ushort *)(*(int *)(unaff_s0 + 0xc0) + 2) = ((uVar4 & 3) - 2) * 0xc;
  ...
  *(short *)(unaff_s0 + 0x42) = sVar1 + -1;
  ...
  do {
    ...
    uVar6 = *in_t6;
    *(uint *)(param_4 + -0x2d) = uVar6 & 0xfff0f0f0;
    copFunction(2,0x280030);
    *(uint *)(param_4 + -0x21) = uVar6 << 4 & in_t8;
    uVar6 = *(uint *)(in_t5 + -0xc);
    ...
    if (-1 < *in_t7) {
      ...
      *in_t7 = iVar9;
      if (0 < *in_t7) {
        ...
        *(uint *)(param_4 + -0x15) = uVar6 & in_t8;
        copFunction(2,0x180001);
        *(uint *)(param_4 + -9) = uVar6 << 4 & in_t8;
        ...
        if (-1 < *in_t7) {
          ...
          *(undefined4 *)(in_t2 + 0x2c) = uVar3;
          if (((((*(ushort *)(param_4 + -0x29) < 0x140) || (*(ushort *)(param_4 + -0x1d) < 0x140))
             ...
             (((uVar6 >> 0x18 & 0x40) == 0 || (_DAT_1f80009c == 0)))) {
