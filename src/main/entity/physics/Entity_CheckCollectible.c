/**
 * @brief Entity collectible check: tests _g_FrameCounter, reads struct at offset
 * @note Original: func_80040C00 at 0x80040C00
 */
// Entity_CheckCollectible
