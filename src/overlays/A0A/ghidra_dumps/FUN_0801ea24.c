...
void FUN_0801ea24(undefined1 *param_1)
  ...
  if (bVar1 == 1) {
    ...
    if (bVar1 == 1) {
      if (DAT_800bf841 == '\0') {
        ...
        *(short *)(param_1 + 0x2e) = (short)(iVar4 * 0x4b0 >> 0xc) + 0x12c0;
        iVar4 = func_0x00083e80((int)*(short *)(param_1 + 0x62));
        *(short *)(param_1 + 0x36) = 0x1162 - (short)(iVar4 * 0x4b0 >> 0xc);
        *(ushort *)(param_1 + 0x62) = *(short *)(param_1 + 0x62) + 8U & 0xfff;
      }
      func_0x00116e9c(param_1);
    }
    else if (bVar1 < 2) {
      if (bVar1 == 0) {
        iVar4 = func_0x00083f50((int)*(short *)(param_1 + 0x62));
      ...
      func_0x00116fc8(param_1);
    }
    else if (bVar1 == 3) {
      func_0x0011738c(param_1);
      if ((param_1[1] == '\0') && (iVar4 = func_0x00117864(param_1), iVar4 != 0)) {
  ...
  if (bVar1 == 0) {
    ...
    if (bVar1 < 2) {
      if (bVar1 == 0) {
        ...
        *(undefined2 *)(param_1 + 0x7c) = 0xfb28;
        *(undefined2 *)(param_1 + 0x32) = 0xfb28;
        *(undefined2 *)(param_1 + 0x80) = 400;
        *(undefined2 *)(param_1 + 0x82) = 800;
        *(undefined2 *)(param_1 + 0x84) = 100;
        *(undefined2 *)(param_1 + 0x86) = 200;
        *(undefined2 *)(param_1 + 0x78) = 0x4b0;
        *(undefined2 *)(param_1 + 0x7a) = 0x12c0;
        *(undefined2 *)(param_1 + 0x7e) = 0x1162;
        *param_1 = 1;
        param_1[0x29] = 0;
