...

{
  ...
  *(byte *)(param_1 + 0x177) = *(byte *)(param_1 + 0x177) | 2;
  ...
  if (bVar1 == 1) {
    if (((*(char *)(param_1 + 0x2a) == '\x01') && (*(char *)(param_1 + 0x29) != '\0')) &&
    ...
    uVar4 = *(short *)(param_1 + 0x4a) + 0x400;
    ...
    *(int *)(param_1 + 0x30) = *(int *)(param_1 + 0x30) + *(short *)(param_1 + 0x4a) * 0x100;
    ...
    if (bVar1 == 0) {
      ...
      *(char *)(param_1 + 0x149) = cVar2;
      ...
      if (iVar5 != 0) {
        *(undefined4 *)(iVar5 + 0x1c) = 0x8012e454;
      ...
      else if (*(char *)(param_1 + 0x145) == '\x02') {
