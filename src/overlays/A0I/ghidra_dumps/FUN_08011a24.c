...
void FUN_08011a24(undefined1 *param_1)

{
  ...
  if (bVar1 < 2) {
    ...
    iVar5 = func_0x00051b70(param_1,0xc,*(undefined1 *)((uint)(byte)param_1[3] * 2 + -0x7fef35f0));
    if (iVar5 == 0) {
      param_1[0xbf] = 1;
      ...
      *(undefined2 *)(param_1 + 0x5a) = *(undefined2 *)(param_1 + 0x56);
      ...
      cVar2 = *(char *)((uint)(byte)param_1[3] * 2 + -0x7fef35ef);
      if (cVar2 != '\0') {
        param_1[0x2a] = cVar2;
        uVar6 = (uint)(byte)param_1[3];
        *(short *)(param_1 + 0x60) =
             *(short *)((uint)(byte)param_1[3] * 0xc + -0x7fef35ec) - *(short *)(param_1 + 0x2e);
        *(undefined2 *)(param_1 + 0x62) = *(undefined2 *)(uVar6 * 0xc + -0x7fef35ea);
        *(short *)(param_1 + 100) =
             *(short *)(uVar6 * 0xc + -0x7fef35e8) - *(short *)(param_1 + 0x36);
        param_1[0x5f] = *(undefined1 *)(uVar6 * 0xc + -0x7fef35e6);
        uVar3 = *(ushort *)(uVar6 * 0xc + -0x7fef35e4);
        *(ushort *)(param_1 + 0x82) = uVar3;
        iVar5 = (uint)uVar3 << 0x10;
        *(short *)(param_1 + 0x80) = (short)((iVar5 >> 0x10) - (iVar5 >> 0x1f) >> 1);
        uVar3 = *(ushort *)(uVar6 * 0xc + -0x7fef35e2);
        *param_1 = 1;
