...
#include "tomba.h"
void Entity_DrawUI2(int param_1,u8 param_2)

{
  ...
  Event_TypeDispatch((int)*(s16 *)(&DAT_800d1e6a + (uint)*(u8 *)(param_1 + 0x2d) * 0xc),local_30);
  ...
  local_34 = 0;
  local_3f = param_2;
  GPU_SpriteDrawMain(&local_38,PTR_DAT_800174c8,*(s32 *)(param_1 + 4),&local_40);
  ...
  do {
    ...
    psVar1 = psVar10 + 4;
    psVar10 = psVar10 + 6;
    GPU_SpriteDrawMain(&local_38,(&PTR_DAT_80017334)[*psVar1],*(s32 *)(param_1 + 4),&local_40);
  ...
  if (0 < sVar2) {
    ...
    do {
      ...
      uVar4 = UI_StringParse(*ppuVar9);
      iVar5 = Game_CheckUnlock(iVar5);
      if (iVar5 == 0) {
        puVar7 = *ppuVar9;
        uVar6 = 0;
      }
      ...
      iVar8 = iVar8 + 0x14;
      GPU_RenderSprite_V2(0xb0,iVar5 * 0x10000 >> 0x10,uVar6,puVar7,0);
      iVar11 = iVar11 + 1;
      iVar5 = iVar11 * 2;
    } while (iVar11 < sVar2);
  }
