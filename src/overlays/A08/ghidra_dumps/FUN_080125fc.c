...
undefined4 FUN_080125fc(byte *param_1,int param_2,int param_3)

{
  ...
  iVar12 = (uint)*(ushort *)(param_1 + 0x2e) - ((uint)*(ushort *)(param_3 + 0x2c) + iVar13);
  ...
  if ((int)(uint)uVar6 <= (int)*(short *)(param_1 + 0x80) + (int)*(short *)(param_2 + 0x80)) {
    ...
    if ((iVar9 < (int)sVar7 - (int)(short)iVar8) || (iVar9 < 3)) {
      ...
      *(short *)(param_1 + 0x2e) =
           (short)(iVar8 * ((int)sVar7 + (int)sVar1) >> 0xc) +
           *(short *)(param_3 + 0x2c) + (short)iVar13;
      sVar7 = *(short *)(param_3 + 0x34);
      param_1[0x60] = 1;
      iVar13 = (int)_DAT_1f80009c;
      *(short *)(param_1 + 0x36) =
           sVar7 - (short)(iVar9 * ((int)*(short *)(param_1 + 0x80) + (int)sVar2) >> 0xc);
      cVar4 = func_0x00077768(iVar13,(int)*(short *)(param_1 + 0x140));
      param_1[0x5f] = cVar4 + 2;
      iVar13 = func_0x00077768((int)*(short *)(param_1 + 0x56),(int)_DAT_1f80009c,0);
      if (iVar13 == 0) {
        halt_baddata();
      }
