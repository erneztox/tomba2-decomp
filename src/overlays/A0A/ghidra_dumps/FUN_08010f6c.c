        ...
        if (DAT_1f800182 != '\0') {
          ...
          if ((*pbVar3 & 1) != 0) {
            ...
            if (bVar1 != 0x18) {
              if (bVar1 < 0x19) {
                if (bVar1 == 0x17) {
                  if (pbVar3[0x47] == 2) goto joined_r0x08011008;
                  func_0x00023870(pbVar4,pbVar3,*(undefined4 *)(pbVar3 + 0xc0));
                }
              }
              else if (bVar1 == 100) {
                if (pbVar4[2] == 0x65) {
                  func_0x00109314(pbVar4);
                }
                goto joined_r0x08011008;
              }
