/**
 * @brief Submits ZX-axis rotated sprite: dual GTE rotation before MVMVA
 * @note Original: func_8003265C at 0x8003265C
 */
// Entity_SubmitSpriteRotZX



/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_8003265c(undefined4 *param_1,byte *param_2,int param_3)
