/**
 * @brief CD slot release: checks slot < 0x10, calls CD_FlushBuffer, clears, decrements counter
...
void CD_ReleaseSlot(u16 param_1)

{
  ...
  if (param_1 < 0x10) {
    ...
    if ((*(u8 *)(iVar1 + -0x7fefa2e8) < 3) && (*(u8 *)(iVar1 + -0x7fefa2e8) != 0)) {
      CD_FlushBuffer(*(s32 *)(iVar1 * 4 + -0x7fefa288));
