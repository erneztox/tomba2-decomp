...
void FUN_8011d208(short *param_1,int param_2,short *param_3,short *param_4)

{
  ...
  *(int *)(param_1 + 0x18) = in_v0 + (int)param_3;
  iVar4 = *(int *)(unaff_s3 + 0xc0);
  iVar3 = unaff_s5 + *(int *)(in_v0 + (int)param_3 + in_v1 * 4 + unaff_s6);
  while( true ) {
    if (param_2 == 0) {
      trap(0x1c00);
    }
