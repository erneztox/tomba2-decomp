...
/* WARNING: Removing unreachable block (ram,0x00109f40) */

void FUN_08010b30(int param_1,int param_2,int param_3)

{
  ...
  if (bVar9 < 2) {
    ...
    if ((*(char *)(param_1 + 0x5f) == '\x10') &&
      ...
      *(ushort *)(param_1 + 0x32) =
           uVar6 + (*(short *)(param_1 + 0x86) - *(ushort *)(param_1 + 0x84)) + 0x40;
      halt_baddata();
    }
  }
  else {
    ...
    if (*(short *)(param_1 + 0x82) + 0x80 <
        (int)((uint)*(ushort *)(param_1 + 0x80) +
              ((uint)*(ushort *)(param_1 + 0x2e) - (uint)*(ushort *)(param_3 + 0x2c)) + 0x40 &
             0xffff)) {
      return;
    }
  }
...
LAB_08010f20:
  ...
  if ((*(byte *)(param_1 + 0x46) & 8) == 0) {
    uVar7 = (ushort)*(byte *)((*(byte *)(param_1 + 0x46) & 7) + 0x80118274);
  }
  sVar1 = 0xa00;
