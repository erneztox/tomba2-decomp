// A0G_GTE_TriangleProc - GTE triangle processor: 3-point transform, bounds check

/* WARNING: Control flow encountered bad instruction data */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

undefined4 * A0G_GTE_TriangleProc(undefined4 *param_1,undefined4 param_2,int param_3)
