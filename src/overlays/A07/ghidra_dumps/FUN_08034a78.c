  ...
  if (*(char *)(param_1 + 6) != '\0') {
    ...
    if (DAT_800bf873 == '\0') {
      ...
      for (; puVar7 < (ushort *)(param_1 + (uint)bVar1 * 2 + 0x10); puVar7 = puVar7 + 1) {
        ...
        uVar6 = *puVar5;
        uVar4 = func_0x0012c7e0(puVar5 + 1,uVar3,uVar6 & 0xff);
        func_0x0012caa8(uVar4,uVar3,uVar6 >> 0x10 & 0xff);
      }
    }
    else {
      iVar9 = *(int *)(param_1 + 0xc);
      ...
      if (puVar7 < puVar8) {
        do {
          ...
          uVar6 = *puVar5;
          uVar4 = func_0x0012cdf4(puVar5 + 1,uVar3,uVar6 & 0xffff,0);
          func_0x0012d2b4(uVar4,uVar3,uVar6 >> 0x10,0);
        } while (puVar7 < puVar8);
