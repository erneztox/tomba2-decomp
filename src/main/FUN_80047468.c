...
undefined4 FUN_80047468(int param_1,short param_2,short param_3,short param_4)

{
  ...
  _DAT_1f8001c0 = *(short *)(param_1 + 0x36) + (short)(-iVar2 * iVar6 >> 0xc);
  _DAT_1f8001bc = *(short *)(param_1 + 0x2e) + (short)(iVar3 * iVar6 >> 0xc);
  iVar2 = FUN_800498c8();
  if (iVar2 != 0) {
