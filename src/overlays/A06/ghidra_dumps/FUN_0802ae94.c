...
LAB_0802b020:
  ...
  if (bVar1 < 2) {
    ...
    if (((((DAT_800e7eaa == '\x01') &&
          (sVar2 = *(short *)(param_1 + 0x2e), *(short *)(param_1 + 0x2e) < _DAT_800e7eae)) &&
         (_DAT_800e7eb6 = *(undefined2 *)(param_1 + 0x36), _DAT_800e7eae = sVar2,
         DAT_800e7ea9 != '\0')) && ((DAT_800e7ffb == '\0' && (DAT_800bf80d == '\0')))) &&
       (DAT_800bf839 == '\0')) {
      DAT_1f800137 = 2;
