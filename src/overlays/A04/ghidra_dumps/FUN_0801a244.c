...
void FUN_0801a244(byte *param_1,undefined4 param_2)
  ...
  if (((short)(sVar1 + 1) < 6) ||
    ...
    if ((((_DAT_800ecf54 & _DAT_1f80016c) == 0) || (param_1[0x147] != 1)) &&
      ...
      if ((_DAT_800ecf54 & 0x10) == 0) {
        ...
        func_0x00062a30(param_1,param_2,0x81);
      }
      else {
        param_1[7] = 5;
        func_0x00054d14(param_1,0x34,0);
        func_0x00062a30(param_1,param_2,0);
      }
    }
    else {
      param_1[7] = 6;
      func_0x00054d14(param_1,0xa8,0);
    }
  }
  else {
    param_1[7] = 0;
    ...
    param_1[0x43] = 0;
    *param_1 = *param_1 | 4;
    func_0x00054d14(param_1,0x37,0);
  }
