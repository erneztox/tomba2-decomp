// A0I_GameStateDispatch - Game state dispatcher: switch on player state (8 cases)

/* WARNING: Control flow encountered bad instruction data */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void A0I_GameStateDispatch(void)

{
  ...
  if (g_PlayerEntity < 8) {
                    /* WARNING: Could not emulate address calculation at 0x08010770 */
  ...
  while (DAT_1f800182 != '\0') {
    ...
    if ((*pbVar3 & 1) != 0) {
      if (pbVar3[0xc] == 9) {
        func_0x001090f0(&g_PlayerEntity);
  ...
  if (_DAT_800e7fd8 < 2) {
    while (DAT_1f800182 = cVar1, DAT_1f800182 != '\0') {
      ...
      puVar5 = puVar5 + 1;
      cVar1 = DAT_1f800182;
      if (((*pbVar3 & 1) != 0) && (uVar2 = pbVar3->kind - 0xc, uVar2 < 0x15)) {
                    /* WARNING: Could not emulate address calculation at 0x0801097c */
                    /* WARNING: Treating indirect jump as call */
        (**(code **)(uVar2 * 4 + -0x7fef6fe8))();
        return;
      }
    }
  }
