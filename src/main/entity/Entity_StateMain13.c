...
#include "tomba.h"
#include "overlay.h"
void Entity_StateMain13(u8 *param_1)

{
  ...
  case 3:
    ...
    sVar2 = Math_ApproachAngle_2(uVar5 & 0xfff,(int)param_1->rot_y,0x100);
    param_1->rot_y = sVar2;
  ...
  case 2:
    ...
    uVar5 = Entity_Behavior_Swing(param_1);
    if ((uVar5 & 1) == 0) {
      param_1[0x61] = 0;
      param_1->action_state = param_1->action_state + 1;
...
LAB_8005d630:
      ...
      *param_1 = *param_1 | 4;
      ...
      Collision_GetSurfaceType(param_1,(_DAT_1f80018e & 0x100) != 0);
      if (uVar5 == 1) {
        param_1[0x61] = 0x11;
        g_SFXState = 0x80;
      ...
      if ((_DAT_1f80018e & 0x8000) == 0) {
        if ((_DAT_1f80018e & 0x300) == 0) {
          iVar4 = Entity_Behavior_Painter(param_1);
          if (iVar4 != 0) {
            DAT_800bf809 = 1;
            param_1[0x61] = 0x80;
          ...
          iVar4 = Entity_Behavior_End(param_1,0);
          if (iVar4 != 0) {
            *param_1 = 7;
            g_ActionTrigger = 1;
            param_1->state = 4;
  ...
  case 7:
    ...
    if (param_1->state_ptr != 0) {
      ...
      if (param_1->state_ptr == 1) {
        ...
        Entity_LoadAnimIfChanged(param_1,0x40,2);
        param_1[0x40] = 3;
        param_1[0x41] = 0;
        return;
      }
      ...
      param_1[0x58] = 0;
      param_1[0x59] = 0;
      Entity_LoadAnimIfChanged(param_1,0x29,4);
      return;
    }
    if (param_1->collision_state == 0) {
      return;
    }
    Entity_LoadAnimIfChanged(param_1,0x65,2);
...
LAB_8005dd48:
  ...
  case 9:
    ...
    param_1->anim_counter = uVar3;
    param_1->action_state = param_1->action_state + 1;
    Entity_LoadAnimIfChanged(param_1,4,3);
  case 10:
    Entity_AnimFrame(param_1);
  ...
  case 0xc:
    *(int *)(param_1 + 0x2c) = *(int *)(param_1 + 0x2c) + param_1->normal_x * 0x1000;
    ...
    iVar4 = Collision_CheckFull2(param_1,uVar6,(int)-param_1->target_angle,uVar6);
    if (iVar4 == 0) {
      return;
    }
    ...
    if (1 < iVar4 - 2U) {
      ...
      Audio_PlaySoundEffect(5,3,0xffffffc4);
      return;
    }
  ...
  case 0xd:
    ...
    Entity_LoadAnimIfChanged(param_1,0x16,6);
    return;
  case 0xe:
    bVar1 = 9;
