...
void FUN_0801c0ac(undefined1 *param_1)

{
  ...
  if (bVar1 == 1) {
    ...
    if (param_1[0x29] != '\0') {
      ...
      *(short *)(*(int *)(param_1 + 0xc0) + 10) = *(short *)(*(int *)(param_1 + 0xc0) + 10) + -0x800
      ;
    }
    ...
    if (bVar1 == 0) {
      iVar4 = func_0x00051b70(param_1,0xc,2);
      if (iVar4 != 0) {
        return;
      }
