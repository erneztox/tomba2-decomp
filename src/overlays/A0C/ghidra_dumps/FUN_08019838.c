...
void FUN_08019838(int param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  if (iVar1 == 0) {
    ...
    func_0x0002847c(0x8011dbc0,*(undefined1 *)((*(byte *)(param_1 + 5) >> 1) + 0x8011dc50),0);
    func_0x0002847c(0x8011db78,*(undefined1 *)((*(byte *)(param_1 + 6) >> 1) + 0x8011dc50),0);
  }
  return;
}
