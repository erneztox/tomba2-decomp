...
MAPPINGS = {
    ...
    0x80069A2C: ("Entity_CalcAngleToTarget_2", "Calculates angle from entity to target point using GTE cos/sin + atan2"),
    ...
    0x8009BBEC: ("CD_GetStatus_2", "CD status getter: returns DAT_800acf44"),
    ...
    0x8008EE80: ("Audio_ResetChannel_2", "Audio channel reset: clears GPU flags, resets struct fields 0x18/0x19/0x60/0x27"),
    ...
    0x80083AF8: ("Mem_Set_2", "Memory set: fills param_3 bytes with value param_2 starting at param_1"),
    ...
    0x8004DD90: ("UI_UpdateElement_2", "UI element update: calls FUN_80049e54, updates pos from entity[0x42] + offset"),
    ...
    0x8004EDDC: ("UI_DrawElement_2", "UI element draw: builds 6-word primitive from params, draws at position"),
    ...
    0x80054198: ("Entity_ResetState_2", "Entity state reset: clears entity[0x44/0x45/0x182] if conditions met"),
    ...
    0x800837A4: ("GPU_StoreImage_2", "GPU store image: sends StoreImage cmd, waits for DMA completion"),
    ...
    0x800776F8: ("Math_ApproachAngle_2", "Angle approach: steps param_1 toward param_2 by ±param_3, handles wrap"),
    ...
    0x8001CBA8: ("Pad_Init_2", "Pad/controller init: sets up input config, handles 0xFF default case"),
    ...
    0x80048894: ("Collision_Check2_2", "Collision check variant 2: saves entity pos, tests collision flags"),
    ...
    0x800489E4: ("Collision_Check3_2", "Collision check variant 3: saves entity pos at _DAT_1f8001bc/c0/c2"),
    0x80073750: ("UI_StringParse", "UI string parser: tokenizes string by spaces, calls handler"),
    0x800438D4: ("Entity_BehaviorDispatch_2", "Entity behavior dispatcher: switch on entity type, calls handler"),
    ...
    0x80083890: ("GPU_MoveImage_2", "GPU move image: sends MoveImage cmd, waits for DMA, returns"),
    ...
    0x800376EC: ("Entity_DrawChild2_2", "Entity child drawer variant 2: builds quad from child data at offset"),
    ...
    0x80022190: ("Entity_DrawChild3_2", "Entity child drawer variant 3: reads sprite from param2[0x6C]"),
    ...
    0x8006804C: ("Entity_SpawnCollectible_2", "Entity collectible spawner: allocs entity, sets type+pos"),
    ...
    0x8009A1F0: ("CD_ReadSector_2", "CD sector reader: reads sector data, handles retry logic"),
    ...
    0x800558B4: ("Entity_Behavior_Jump_2", "Entity jump behavior: checks timer, applies velocity"),
    ...
    0x80072308: ("Entity_SpawnEffect_2", "Entity effect spawner: allocs child, sets sprite+pos"),
    ...
    0x80092080: ("Audio_SeqCmd_2", "Audio sequence command: sends cmd to SEQ player"),
    ...
    0x8007C0D0: ("Entity_ScriptRun_2", "Entity script runner: reads bytecode from entity[0x14]"),
