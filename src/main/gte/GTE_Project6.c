/**
 * @brief GTE project variant 6: loads matrix, projects, stores result
 * @note Original: func_80032AB4 at 0x80032AB4
 */
// GTE_Project6
...
void FUN_80032ab4(undefined4 *param_1,byte *param_2)
