// A0I_ScreenTransform - Screen-space coordinate transform with sin/cos

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void A0I_ScreenTransform(int param_1)

{
  ...
  func_0x0010c440(param_1,&local_30,&local_28,&local_20);
  return;
}
