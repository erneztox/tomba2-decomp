...
undefined4 FUN_0801e520(undefined1 *param_1)

{
  ...
  *(short *)(*(int *)(param_1 + 0xc4) + 0x3a) = *(short *)(*(int *)(param_1 + 0xc4) + 0x3a) + -0x100
  ;
  *(short *)(*(int *)(param_1 + 200) + 2) =
       (short)((int)((int)*(short *)(*(int *)(param_1 + 0xc4) + 0x12) *
                    (uint)*(ushort *)(*(int *)(param_1 + 0xc4) + 0x3a)) >> 0xc);
  if (*(short *)(*(int *)(param_1 + 0xc4) + 0x3a) == 0) {
