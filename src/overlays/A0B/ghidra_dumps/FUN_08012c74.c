...
/* WARNING: Removing unreachable block (ram,0x08012d48) */
/* WARNING: Removing unreachable block (ram,0x08012d60) */
/* WARNING: Removing unreachable block (ram,0x08012d64) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_08012c74(int param_1,int param_2)
