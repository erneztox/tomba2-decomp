...
void GTE_Project8(int param_1,s32 param_2,s32 param_3,s32 param_4)

{
  ...
  uVar7 = DAT_800102b8;
  GTE_LoadRotMatrixFromSVec(param_1 + 0x48,0x1f800000,param_3,param_4,DAT_800102b8);
  ...
  Entity_SubmitQuadToOT(&DAT_800a16c0,0,0,0);
  return;
}
