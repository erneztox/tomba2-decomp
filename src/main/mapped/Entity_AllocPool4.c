/**
 * @brief Allocates entity from pool 4 with list insertion modes
 * @note Original: func_8007A2C8 at 0x8007A2C8
 */
// Entity_AllocPool4
...
undefined1 * FUN_8007a2c8(int param_1,undefined1 param_2,int param_3,int param_4)

{
  ...
  if (_DAT_800ed8d0 == (undefined1 *)0x0) {
    return (undefined1 *)0x0;
  }
  uVar5 = *(undefined4 *)(_DAT_800ed8d0 + 0x24);
  DAT_800ed8c4 = DAT_800ed8c4 + -1;
  if (param_4 == 1) {
  ...
  if (param_3 != 1) {
    if (1 < param_3) {
      if (param_3 == 2) {
        if (*(int *)(param_1 + 0x24) != 0) {
          piVar4 = (int *)(_DAT_800ed8d0 + 0x20);
          _DAT_800ed8d0 = (undefined1 *)uVar5;
          *piVar4 = param_1;
      ...
      else if (param_3 != 3) goto LAB_8007a44c;
      iVar3 = *piVar4;
      puVar1 = (undefined4 *)(_DAT_800ed8d0 + 0x24);
      _DAT_800ed8d0 = (undefined1 *)uVar5;
      *puVar1 = 0;
    ...
    if (param_3 != 0) goto LAB_8007a44c;
  ...
  puVar1 = (undefined4 *)(_DAT_800ed8d0 + 0x20);
  _DAT_800ed8d0 = (undefined1 *)uVar5;
  *puVar1 = 0;
