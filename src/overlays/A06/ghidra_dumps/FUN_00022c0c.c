...

{
  ...
  sStack00000014 = *(short *)(*(int *)(unaff_s1 + 0xc0) + 0x34) + (short)(in_v0 >> 7);
  iVar1 = FUN_0003f7a0(&stack0x00000010,&stack0x00000018);
  ...
  if (0 < in_stack_0000001c) {
    do {
      ...
      FUN_0003f7a0(&stack0x00000010,&stack0x00000020);
      iVar1 = iVar1 + 1;
  ...
  do {
    if (iVar1 != 0) {
      uStack00000010 = *(undefined2 *)(iVar2 + 0x2c);
      sStack00000012 = *(undefined2 *)(iVar2 + 0x30);
      sStack00000014 = *(undefined2 *)(iVar2 + 0x34);
      iVar1 = FUN_0003f7a0(&stack0x00000010,&stack0x00000018);
      in_stack_0000001c = (iVar1 >> (iVar1 >> 10 & 0x1fU)) + (iVar1 >> 10) * 0x200;
      if (0x7fb < in_stack_0000001c - 4U) {
        in_stack_0000001c = -1;
      }
      uStack00000010 = *(undefined2 *)(iVar3 + 0x2c);
      sStack00000012 = *(undefined2 *)(iVar3 + 0x30);
      sStack00000014 = *(undefined2 *)(iVar3 + 0x34);
      iVar1 = FUN_0003f7a0(&stack0x00000010,&stack0x00000020);
