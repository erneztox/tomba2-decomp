...
void FUN_080257c8(undefined1 *param_1)

{
  ...
  if (bVar1 == 1) {
    ...
    if (param_1[0x29] != '\0') {
      ...
      *(short *)(*(int *)(param_1 + 0xc0) + 10) = *(short *)(*(int *)(param_1 + 0xc0) + 10) + -0xc00
      ;
    }
    ...
    if (bVar1 == 0) {
      iVar4 = func_0x00051b70(param_1,0xc,(int)*(short *)((uint)(byte)param_1[3] * 2 + -0x7febec40))
      ;
      if (iVar4 != 0) {
        return;
      }
      ...
      *(undefined2 *)(*(int *)(param_1 + 0xc0) + 10) = 0xf400;
      if (param_1[3] == '\0') {
        *(undefined2 *)(param_1 + 0x60) = 0x117;
      }
      else if (param_1[3] == '\x01') {
        *(undefined2 *)(param_1 + 0x60) = 0x158;
      }
      else {
        *(undefined2 *)(param_1 + 0x60) = 0x1c0;
      }
    }
  }
                    /* WARNING: Bad instruction - Truncating control flow here */
