...
#include "tomba.h"
s32 Entity_CalcAngle20(u8 *param_1,int param_2,int param_3)

{
  ...
  if (bVar4) {
    if ((*param_1 & 4) == 0) {
      iVar8 = Math_CosGTE(_g_AngleTarget);
      sVar1 = param_1->bounds_min_x;
      sVar2 = param_2->bounds_min_x;
      iVar9 = Math_Cos(_g_AngleTarget);
    ...
    param_1[0x60] = 1;
    cVar5 = Math_CompareAngle((int)_g_AngleTarget,(int)param_1->draw_angle,1);
