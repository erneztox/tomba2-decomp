...

{
  ...
  if (bVar3 != 1) {
    if (bVar3 < 2) {
      ...
      if (((0x1928 < _DAT_800e7eb6) && (DAT_1f800137 == '\0')) &&
         (((DAT_800e7ff7 & 2) != 0 && ((_DAT_800e7ffe & 0x640) == 0)))) {
        *(undefined1 *)(param_1 + 4) = 1;
        *(undefined1 *)(param_1 + 0xb) = 0;
        *(undefined1 *)(param_1 + 0xd) = 0;
        func_0x0012e340(param_1,0);
...
LAB_08035708:
    ...
    *(short *)(param_1 + 0x42) = sVar4;
    if ((int)((uint)*(byte *)(param_1 + 0x46) << 1) <= (int)sVar4) {
      *(undefined2 *)(*(int *)(param_1 + (*(byte *)(param_1 + 0x46) - 1) * 4 + 0xc0) + 0x3a) =
           0x1000;
      func_0x0012e340(param_1,*(undefined1 *)(param_1 + 0x46));
  ...
  if ((((_DAT_800e7eb6 < 0x1929) || (DAT_1f800137 != '\0')) || ((DAT_800e7ff7 & 2) == 0)) ||
     ((_DAT_800e7ffe & 0x640) != 0)) {
