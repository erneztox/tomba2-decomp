...
void FUN_0801d358(undefined1 *param_1)

{
  ...
  if (bVar1 == 1) {
    ...
    if (bVar1 == 1) {
      if (DAT_800bf841 == '\0') {
        ...
        *(short *)(param_1 + 0x2e) = (short)(iVar4 * 0x500 >> 0xc) + 0x2980;
        *(undefined2 *)(param_1 + 0x36) = 0x1fa0;
        *(ushort *)(param_1 + 0x76) = *(short *)(param_1 + 0x76) + 0x10U & 0xfff;
        *(ushort *)(param_1 + 0x62) = *(short *)(param_1 + 0x62) + 8U & 0xfff;
      }
      func_0x001157d0(param_1);
    }
    else if (bVar1 < 2) {
      if (bVar1 == 0) {
        iVar4 = func_0x00083e80((int)*(short *)(param_1 + 0x76));
      ...
      func_0x001158fc(param_1);
    }
    else if (bVar1 == 3) {
      func_0x00115cc0(param_1);
      if ((param_1[1] == '\0') && (iVar4 = func_0x00116198(param_1), iVar4 != 0)) {
  ...
  if (bVar1 == 0) {
    ...
    if (bVar1 < 2) {
      if (bVar1 == 0) {
        iVar4 = func_0x00051b70(param_1,0xc,10);
        if (iVar4 != 0) {
          return;
        }
        ...
        *(undefined2 *)(param_1 + 0x78) = 0x500;
        *(undefined2 *)(param_1 + 0x7a) = 0x2980;
        *(undefined2 *)(param_1 + 0x76) = 0;
        *(undefined2 *)(param_1 + 0x7c) = 0xf7cc;
        *(undefined2 *)(param_1 + 0x32) = 0xf7cc;
        *param_1 = 1;
        param_1[0x29] = 0;
        ...
        *(undefined2 *)(param_1 + 0x7e) = 0x1fa0;
