...

{
  ...
  if (bVar1 == 1) {
    ...
    func_0x00040d68(param_1,0x80141db0);
    ...
    *(char *)(param_1 + 6) = *(char *)(param_1 + 6) + '\x01';
    ...
    if (bVar1 == 0) {
      ...
      *(int *)(param_1 + 0x30) = *(int *)(param_1 + 0x30) + ((int)((uint)uVar2 << 0x10) >> 8);
      func_0x00041938(param_1,0,0x50);
      ...
      *(short *)(param_1 + 0x56) = *(short *)(param_1 + 0x56) + -200;
      DAT_800bf929 = DAT_800bf929 | 0x40;
      *(char *)(param_1 + 6) = *(char *)(param_1 + 6) + '\x01';
    }
  }
  else if (bVar1 == 2) {
    ...
    if (bVar1 == 1) {
      func_0x00040d68(param_1,0x80141dc8);
      *(undefined1 *)(param_1 + 0x70) = 2;
      *(char *)(param_1 + 7) = *(char *)(param_1 + 7) + '\x01';
    }
    else if (bVar1 < 2) {
      if (bVar1 == 0) {
        *(undefined1 *)(param_1 + 0x7a) = 9;
                    /* WARNING: Bad instruction - Truncating control flow here */
        halt_baddata();
      }
    }
