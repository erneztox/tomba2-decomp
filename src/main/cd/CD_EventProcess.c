...
s32 CD_EventProcess(int param_1)

{
  ...
  if (param_1 != DAT_800ac2d4) {
    pbVar2 = &DAT_80104368;
    iVar1 = CD_OpenFile(1,*(s32 *)(param_1 * 0x2c + -0x7fefd2bc),&DAT_80104368);
    if (iVar1 != 1) {
      if (DAT_800abfc4 < 1) {
        return 0xffffffff;
      }
      Debug_Printf(s_CD_cachefile__dir_not_found_8001c4ec);
      return 0xffffffff;
    }
    if (1 < DAT_800abfc4) {
      Debug_Printf(s_CD_cachefile__searching____8001c50c);
    }
    iVar3 = 0;
    puVar5 = &DAT_80102768;
    puVar4 = &DAT_80102770;
    iVar1 = 0;
    while (*pbVar2 != 0) {
      CD_CalcSector(*(s32 *)(pbVar2 + 2),puVar5);
      *(s32 *)(&DAT_8010276c + iVar1) = *(s32 *)(pbVar2 + 10);
      if (iVar3 == 0) {
        ...
        Mem_Copy(puVar4,pbVar2 + 0x21,pbVar2[0x20]);
        puVar4[pbVar2[0x20]] = 0;
      }
      if (1 < DAT_800abfc4) {
        Debug_Printf(s___02x__02x__02x___8d__s_8001c530,(&DAT_80102768)[iVar1],
    ...
    Debug_Printf(s_CD_cachefile___d_files_found_8001c54c,iVar3);
  }
  return 1;
}
