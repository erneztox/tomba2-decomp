...

{
  ...
  iVar3 = 0;
  iVar1 = (uint)*(u16 *)(param_2 + 2) - (uint)*(u16 *)((int)param_1 + 2);
  sVar2 = (s16)param_3;
  if ((iVar1 + 10U & 0xffff) < 0x15) {
    *(u16 *)((int)param_1 + 2) = *(u16 *)(param_2 + 2);
    iVar3 = 1;
  }
  else {
    if (param_3 != 0) {
  ...
  iVar1 = (uint)*(u16 *)(param_2 + 6) - (uint)*(u16 *)((int)param_1 + 6);
  if ((iVar1 + 10U & 0xffff) < 0x15) {
    *(u16 *)((int)param_1 + 6) = *(u16 *)(param_2 + 6);
    iVar3 = iVar3 + 1;
  }
  else {
    if (param_3 != 0) {
  ...
  iVar1 = (uint)*(u16 *)(param_2 + 10) - (uint)*(u16 *)((int)param_1 + 10);
  if ((iVar1 + 10U & 0xffff) < 0x15) {
    *(u16 *)((int)param_1 + 10) = *(u16 *)(param_2 + 10);
    iVar3 = iVar3 + 1;
  }
  else {
    if (param_3 != 0) {
