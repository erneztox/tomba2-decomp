...
#include "tomba.h"
void FUN_8008f2bc(u16 *param_1,u16 *param_2,u16 *param_3)

{
  ...
  uVar3 = -(u16)(param_1->action_state != 0) & 0x8000;
  ...
  *param_2 = -(u16)(param_1->behavior_state != 0) & 0x8000 | (*param_1 & 0x7f) << 8 | (param_1->flags & 0xf) << 4
             | param_1->kind & 0xf;
