...
LAB_8004f2b8:
  ...
  *(int *)(psVar7 + 0x38) = iVar4;
  *(int *)(psVar7 + 0x3a) = iVar5;
  *(int *)(psVar7 + 0x3c) = iVar6;
  iVar4 = param_2[5];
  iVar5 = param_2[6];
  iVar6 = param_2[7];
  *(int *)(psVar7 + 0x3e) = param_2[4];
  *(int *)(psVar7 + 0x40) = iVar4;
  *(int *)(psVar7 + 0x42) = iVar5;
  *(int *)(psVar7 + 0x44) = iVar6;
  iVar4 = (uint)local_20[0] << 0x10;
  if ((local_20[0] & 1) != 0) {
    iVar4 = local_20[0] + 1;
    local_20[0] = (ushort)iVar4;
    iVar4 = iVar4 * 0x10000;
  }
