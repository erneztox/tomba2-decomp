/**
 * @brief Audio voice key-on: activates voice with ADSR params
 * @note Original: func_80095530 at 0x80095530
 */
// Audio_VoiceKeyOn
  ...
  if ('\0' < DAT_80105cec) {
    ...
    do {
      if ((((DAT_800ac3f4 & 1 << (iVar1 >> 0x10 & 0x1fU)) == 0) &&
        ...
        sVar2 = (s16)iVar8;
        uVar3 = (uint)*(u8 *)(*(s16 *)(sVar2 * 0x38 + -0x7fefab24) * 0x10 + _DAT_80105cdc + 4);
        if (uVar3 < 0x40) {
        ...
        uVar3 = (uint)*(u8 *)(sVar2 * 0x38 + -0x7fefab2e);
        if (uVar3 < 0x40) {
          uVar5 = (uint)((ulonglong)((longlong)(int)((uVar5 & 0xffff) * uVar3) * 0x82082083) >> 0x25
                        );
        }
        ...
        iVar1 = (int)sVar2;
        *(s16 *)(&DAT_80105a28 + iVar1 * 0x10) = (s16)((int)(uVar3 * uVar3) / 0x3fff);
        *(s16 *)(&DAT_80105a2a + iVar1 * 0x10) =
             (s16)((int)((uVar5 & 0xffff) * (uVar5 & 0xffff)) / 0x3fff);
