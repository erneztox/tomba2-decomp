// A0G_MaterialProcessor - Material/color processor: GTE cop2, entity color list

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void A0G_MaterialProcessor(int param_1)

{
  ...
  if (bVar1 != 0) {
    ...
    for (; puVar6 < (u16 *)(param_1 + (uint)bVar1 * 2 + 0x10); puVar6 = puVar6 + 1) {
      ...
      uVar5 = *puVar4;
      uVar3 = func_0x0010bc40(puVar4 + 1,uVar2,uVar5 & 0xff);
      func_0x0010bf28(uVar3,uVar2,uVar5 >> 0x10 & 0xff);
    }
  }
  return;
}
