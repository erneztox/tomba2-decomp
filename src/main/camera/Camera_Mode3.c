...
void Camera_Mode3(void)

{
  _DAT_800e8016 = _g_CameraTargetY + -200;
  _DAT_800e8012 = _g_CameraTargetX;
  _DAT_800e801a = _g_CameraTargetZ;
  Camera_SetFOV(0x800e8008,&DAT_800e8010);
  Camera_SetRoll(0x800e8008,&DAT_800e8010);
  Camera_CalcOrbitPos(0x800e8008);
  Camera_Commit(0x800e8008);
  return;
}
