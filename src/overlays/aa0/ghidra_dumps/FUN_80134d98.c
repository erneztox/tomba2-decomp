...
void FUN_80134d98(short *param_1,short *param_2)

{
  ...
  _DAT_1f8000c4 = CONCAT22(_DAT_1f8000c6,(short)((int)param_1[2] + (int)param_2[2] >> 1));
  ...
  if (-1 < _DAT_1f800080) {
    ...
    if (0 < _DAT_1f800080) {
      ...
      *(short *)((int)puVar2 + 0x1a) =
      ...
      uVar7 = (uint)*(byte *)(uVar3 + 0x8014bd04);
      uVar4 = uVar3 + 4 & 0xf;
      uVar7 = uVar7 << 0x10 | uVar7 << 8 | 0x5e000000 | uVar7;
      puVar2[1] = uVar7;
      puVar2[0xb] = uVar7;
      uVar3 = (uint)*(byte *)(uVar4 + 0x8014bd04);
      uVar4 = uVar4 + 4 & 0xf;
      ...
      puVar2[5] = uVar3;
      puVar2[0xf] = uVar3;
      uVar3 = (uint)*(byte *)((uVar4 + 4 & 0xf) + 0x8014bd04);
      uVar3 = uVar3 << 0x10 | uVar3 << 8 | uVar3;
      puVar2[7] = uVar3;
      puVar2[0x11] = uVar3;
      ...
      *puVar5 = (uint)(puVar2 + 10);
      puVar8 = puVar2 + 0x14;
      func_0x80083de0(puVar8,0,1,0x75,0);
      puVar5 = (uint *)(_DAT_800ed8c8 + _DAT_1f800080 * 4);
