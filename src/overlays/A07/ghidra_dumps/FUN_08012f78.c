...
void FUN_08012f78(int param_1,byte *param_2)

{
  ...
  iVar4 = func_0x0002300c(param_1,param_2,*(short *)(param_2 + 0x80) + 200);
  if (iVar4 != 0) {
    if (((((((int)*(short *)(param_1 + 0x17e) & 0x8200U) == 0) && (_DAT_1f80018e == 0)) &&
         (DAT_1f800137 == '\0')) && (((*param_2 & 2) == 0 && (DAT_800bf873 == '\0')))) &&
       (*(char *)(param_1 + 5) != '\x02')) {
