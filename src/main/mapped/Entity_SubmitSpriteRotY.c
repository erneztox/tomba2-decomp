/**
 * @brief Submits Y-axis rotated sprite: adds GTE rotation on Y before MVMVA
 * @note Original: func_80031AC4 at 0x80031AC4
 */
// Entity_SubmitSpriteRotY



/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_80031ac4(undefined4 *param_1,byte *param_2,int param_3)

{
  ...
  FUN_80085480(param_3,0x1f800000);
  FUN_80051794(&DAT_1f800020);
  FUN_80084d10((int)*(short *)(param_3 + 6),&DAT_1f800020);
  FUN_80084250(0x1f800000,&DAT_1f800020);
  local_28 = (uint)*param_2 << 2;
  local_24 = (uint)param_2[1] << 2;
  local_20 = (uint)param_2[2] << 2;
