// A0H_StateSwitch - Player state switch (8 cases)

/* WARNING: Control flow encountered bad instruction data */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void A0H_StateSwitch(void)

{
  ...
  if (g_PlayerEntity < 8) {
                    /* WARNING: Could not emulate address calculation at 0x0801094c */
  ...
  while (DAT_1f800182 != '\0') {
    ...
    if ((*pbVar3 & 1) != 0) {
      if (pbVar3[0xc] == 9) {
        func_0x001090dc(&g_PlayerEntity);
  ...
  if (_DAT_800e7fd8 < 2) {
    while (DAT_1f800182 = cVar1, DAT_1f800182 != '\0') {
      ...
      if (((*pbVar3 & 1) != 0) && (uVar2 = pbVar3->kind - 0xc, uVar2 < 0x15)) {
                    /* WARNING: Could not emulate address calculation at 0x08010b58 */
                    /* WARNING: Treating indirect jump as call */
