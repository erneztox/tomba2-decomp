// CRD_ResultDispatch (CRD_ResultDispatch) - Results screen dispatch

/* WARNING: Control flow encountered bad instruction data */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void CRD_ResultDispatch(u8 *param_1)

{
  ...
  if ((param_1->rot_y == 0) && ((_g_PlayerFlags & 0x4000) != 0)) {
    ...
    if (*(char *)(iVar1 + (uint)(u8)param_1->sub_anim_id * 0x3c + 6) == '\x01') {
      ...
      String_Copy(_DAT_800bf4a4,_DAT_800a2938);
      _DAT_800bf4b0 = 0x39;
    }
    if (_DAT_800bf4b2 != -1) {
      *_DAT_800bf4a8 = 0;
