...

{
  ...
  *(undefined2 *)(param_1 + 10) = (*(undefined2 **)(param_1 + 0xc))[1];
  ...
  local_28 = local_30 + (iVar1 * (int)_DAT_800a3f90 >> 0xc);
  iVar1 = func_0x00083f50(uVar4);
  uVar4 = _DAT_800a3f94 - _DAT_1f8000f2 & 0xfff;
  local_24 = local_2c + (iVar1 * (int)_DAT_800a3f90 >> 0xc);
  iVar1 = func_0x00083e80(uVar4);
  local_20 = local_30 + (iVar1 * (int)_DAT_800a3f90 >> 0xc);
  iVar1 = func_0x00083f50(uVar4);
  local_1c = local_2c + (iVar1 * (int)_DAT_800a3f90 >> 0xc);
  ...
  iVar2 = (iVar2 * iVar1 >> 0xc) * (int)_DAT_800a3f90 * 5 >> 0x10;
  iVar1 = (iVar3 * iVar1 >> 0xc) * (int)_DAT_800a3f90 * 5 >> 0x10;
  ...
  *(undefined1 *)(param_1 + 6) = 0;
  if (((DAT_800bf871 != '\0') && (DAT_800bf871 != '\x02')) && (DAT_800bf871 != '\x03')) {
    func_0x0010b61c(param_1,&local_30,&local_28,&local_20);
  }
  return;
}
