/**
 * @brief Submits rotated sprite to OT: GTE matrix from 3-u8 rotation + MVMVA transform
 * @note Original: func_800318A0 at 0x800318A0
 */
// Entity_SubmitRotatedSprite
...
void Entity_SubmitRotatedSprite(s32 *param_1,u8 *param_2,s32 param_3)
