/**
 * @brief Entity hang state: entity[6] state, hanging/climbing
...

{
  ...
  if (bVar1 == 1) {
    ...
    *(short *)(param_1 + 100) = sVar2;
    ...
    iVar6 = (int)sVar2;
    iVar3 = iVar6 * *(short *)(param_1 + 0x4e);
    if (iVar3 < 0) {
      iVar3 = iVar3 + 0xfff;
    }
    iVar7 = iVar6 * *(short *)(param_1 + 0x50);
    *(short *)(param_1 + 0x2e) = _DAT_1f800160 + (short)(iVar3 >> 0xc);
    if (iVar7 < 0) {
      iVar7 = iVar7 + 0xfff;
    }
    iVar6 = iVar6 * *(short *)(param_1 + 0x52);
    *(short *)(param_1 + 0x32) = _DAT_1f800162 + (short)(iVar7 >> 0xc);
    if (iVar6 < 0) {
      iVar6 = iVar6 + 0xfff;
    }
    *(short *)(param_1 + 0x36) = _DAT_1f800164 + (short)(iVar6 >> 0xc);
    ...
    *(short *)(param_1 + 0xb8) = sVar2;
    ...
    if (bVar1 < 2) {
      ...
      *(ushort *)(param_1 + 0x56) = uVar5 - 0x800 & 0xfff;
      iVar3 = FUN_80083f50(uVar5);
      iVar3 = iVar3 * *(short *)(param_3 + 2);
      if (iVar3 < 0) {
        iVar3 = iVar3 + 0xfff;
      }
      *(short *)(param_1 + 0x4e) = (short)(iVar3 >> 0xc);
      *(short *)(param_1 + 0x50) = -0x46 - *(short *)(param_3 + 6);
      iVar3 = FUN_80083e80(uVar5);
      iVar3 = -iVar3 * (int)*(short *)(param_3 + 2);
      if (iVar3 < 0) {
        iVar3 = iVar3 + 0xfff;
      }
      *(short *)(param_1 + 0x52) = (short)(iVar3 >> 0xc);
