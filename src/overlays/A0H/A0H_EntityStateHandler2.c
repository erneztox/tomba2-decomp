// A0H_EntityStateHandler2 - Entity state machine variant

/* WARNING: Control flow encountered bad instruction data */

void A0H_EntityStateHandler2(u8 *param_1)
  ...
  if (bVar1 == 1) {
    ...
    *(short *)(param_1->sprite_ptr1 + 0xc) =
    ...
    if (bVar1 == 0) {
      ...
      if (param_1->sub_type == '\0') {
        param_1->bounds_min_x = 600;
        param_1->bounds_size = 0x4b0;
