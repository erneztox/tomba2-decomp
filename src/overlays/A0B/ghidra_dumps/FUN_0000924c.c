...
/* WARNING: Removing unreachable block (ram,0x000095ec) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_0000924c(int param_1)
  ...
  if (-1 < iVar8) {
    ...
    if (-0x33 < iVar8) {
      if (*(char *)(param_1 + 4) == '\x01') {
        ...
        uVar3 = func_0x001120ac(uVar1,(((0xa0 - iVar10) * 7 >> 3) + (int)local_40) * 0x10000 >> 0x10
                                ,(((0x78 - iVar9) * 7 >> 3) + (int)sStack_3e) * 0x10000 >> 0x10,0xc,
                                0xc,iVar11,6);
        iVar10 = (0xa0 - iVar10) * 3;
        iVar9 = (0x78 - iVar9) * 3;
        uVar3 = func_0x001120ac(uVar3,((iVar10 >> 3) + (int)local_40) * 0x10000 >> 0x10,
                                ((iVar9 >> 3) + (int)sStack_3e) * 0x10000 >> 0x10,0x20,0x20,iVar11,6
                               );
        _DAT_800bf544 =
             func_0x001120ac(uVar3,((iVar10 >> 1) + (int)local_40) * 0x10000 >> 0x10,
        ...
        do {
          ...
          while (iVar4 < 0x1001) {
            ...
            if (iVar4 == 0) {
              ...
              func_0x00027a4c(0x8011c07c,_DAT_8011c078);
            }
