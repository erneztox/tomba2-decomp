// A0H_EntityStateHandler - Entity state machine: action dispatch

/* WARNING: Control flow encountered bad instruction data */

void A0H_EntityStateHandler(u8 *param_1)

{
  ...
  if (bVar1 == 1) {
    if (param_1->sub_type == '\0') {
      ...
      if (bVar1 == 1) {
        iVar5 = Entity_ActivatePool3(0x6b,2);
  ...
  if (bVar1 < 2) {
    ...
    iVar5 = Entity_InitSubEntity(param_1,0xc,*(u8 *)((uint)(u8)param_1->sub_type * 2 + -0x7fef3a74));
    if (iVar5 == 0) {
      ...
      cVar2 = *(char *)((uint)(u8)param_1->sub_type * 2 + -0x7fef3a73);
      if (cVar2 != '\0') {
        param_1->collision_dir = cVar2;
        uVar6 = (uint)(u8)param_1->sub_type;
        param_1->draw_x =
             *(short *)((uint)(u8)param_1->sub_type * 0xc + -0x7fef3a70) - param_1->pos_y;
        param_1->angle_delta = *(s16 *)(uVar6 * 0xc + -0x7fef3a6e);
        *(short *)(param_1 + 100) =
             *(short *)(uVar6 * 0xc + -0x7fef3a6c) - param_1->pos_z;
        param_1->input_flags = *(u8 *)(uVar6 * 0xc + -0x7fef3a6a);
        uVar3 = *(u16 *)(uVar6 * 0xc + -0x7fef3a68);
        param_1->bounds_size = uVar3;
        iVar5 = (uint)uVar3 << 0x10;
        param_1->bounds_min_x = (short)((iVar5 >> 0x10) - (iVar5 >> 0x1f) >> 1);
        uVar3 = *(u16 *)(uVar6 * 0xc + -0x7fef3a66);
        *param_1 = 1;
