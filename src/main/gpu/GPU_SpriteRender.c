...

{
  ...
  *param_4 = bVar1 & 0xf;
  ...
  do {
    ...
    _DAT_1f800008 = CONCAT22(_DAT_1f80000a + (char)puVar7->state,_DAT_1f800008 + (char)puVar7->sub_type);
    ...
    puVar5 = (uint *)(_DAT_800ed8c8 + (uint)param_4->flags * 4);
  ...
  puVar6 = (uint *)(_DAT_800ed8c8 + (uint)param_4->flags * 4);
