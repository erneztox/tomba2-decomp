...
undefined4 FUN_08015838(int param_1,int param_2,int param_3)

{
  ...
  if ((int)(uVar3 & 0xffff) <= *(short *)(param_2 + 0x80) + _DAT_1f800088) {
    ...
    if ((int)((uint)*(ushort *)(param_1 + 0x68) +
              ((uint)*(ushort *)(param_1 + 0x14e) - (uint)*(ushort *)(param_3 + 0x30)) + 0x8c &
             0xffff) <= (short)*(ushort *)(param_1 + 0x68) + 0x118) {
