...
uint * FUN_80128c14(uint *param_1,int param_2,int param_3,int param_4)

{
  ...
  if (param_3 != 0) {
    ...
    do {
      ...
      uVar7 = *puVar12;
      puVar9[-9] = uVar7 & 0xfff0f0f0;
      copFunction(2,0x280030);
      puVar9[-6] = uVar7 << 4 & local_2c;
      uVar7 = *(uint *)(psVar10 + -0x11);
      ...
      if (-1 < _DAT_1f800000) {
        ...
        if (0 < _DAT_1f800000) {
          ...
          puVar9[-3] = uVar7 & local_2c;
          copFunction(2,0x180001);
          *puVar9 = uVar7 << 4 & local_2c;
          ...
          if (-1 < _DAT_1f800000) {
            ...
            if (((((((ushort)puVar9[-8] < 0x140) || ((ushort)puVar9[-5] < 0x140)) ||
              ...
              if (uVar8 == 2) {
                ...
                bVar1 = iVar3 < _DAT_1f800090;
                if (_DAT_1f80008c < _DAT_1f800090) {
                  bVar1 = iVar3 < _DAT_1f80008c;
                  iVar2 = _DAT_1f80008c;
                }
                goto LAB_80128f4c;
              }
              if (uVar8 < 3) {
                ...
                _DAT_1f800004 =
                     (_DAT_1f800004 >> (_DAT_1f800004 >> 10 & 0x1fU)) +
                     (_DAT_1f800004 >> 10) * 0x200;
                if (0x7fb < _DAT_1f800004 - 4U) {
                  _DAT_1f800004 = -1;
                }
                if (-1 < _DAT_1f800004) {
                  uVar7 = *(uint *)(psVar10 + -0xb);
                  puVar9[-1] = uVar7;
                  puVar9[2] = uVar7 >> 0x10;
                  if (param_4 != 0) {
                    /* WARNING: Bad instruction - Truncating control flow here */
                  ...
                  iVar2 = func_0x80078240((int)psVar10[-9] - (int)_DAT_1f800160,
                                          (int)psVar10[-8] - (int)_DAT_1f800162,
                                          (int)psVar10[-7] - (int)_DAT_1f800164);
                  iVar2 = iVar2 << 1;
                  iVar3 = func_0x80078240((int)psVar10[-5] - (int)_DAT_1f800160,
                                          (int)psVar10[-4] - (int)_DAT_1f800162,
                                          (int)psVar10[-6] - (int)_DAT_1f800164);
                  iVar3 = iVar3 << 1;
                  iVar4 = func_0x80078240((int)psVar10[-3] - (int)_DAT_1f800160,
                                          (int)psVar10[-2] - (int)_DAT_1f800162,
                                          (int)psVar10[-1] - (int)_DAT_1f800164);
                  iVar4 = iVar4 << 1;
                  iVar5 = func_0x80078240((int)psVar10[1] - (int)_DAT_1f800160,
                                          (int)psVar10[2] - (int)_DAT_1f800162,
                  ...
                  uVar7 = getCopReg(2,0x16);
                  *puVar9 = uVar7;
                  puVar6 = (uint *)(param_2 + _DAT_1f800004 * 4);
                  param_1 = (uint *)0xc000000;
                  *puVar11 = *puVar6 | 0xc000000;
                  *puVar6 = (uint)puVar11;
                  puVar9 = puVar9 + 0xd;
                  puVar11 = puVar11 + 0xd;
                }
