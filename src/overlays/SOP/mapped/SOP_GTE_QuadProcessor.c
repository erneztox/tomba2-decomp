// SOP_GTE_QuadProcessor (SOP_GTE_QuadProcessor) - GTE-based 4-point quad processing: transforms 11-word entries with 2 cop2 operations

/* WARNING: Control flow encountered bad instruction data */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint * SOP_GTE_QuadProcessor(uint *param_1,undefined4 param_2,int param_3)

{
  ...
  if (param_3 != 0) {
    ...
    do {
      ...
      *(uint *)(iVar3 + 0x10) = (uVar5 & 0xf0f0f) << 4;
      uVar5 = puVar8[-3];
