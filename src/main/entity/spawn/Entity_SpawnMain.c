...
LAB_80074328:
      if (param_1->move_mode == '\x03') {
        iVar3 = FUN_8007e110((int)u____01_800a4cf8[(u8)param_1->sub_type],0);
    ...
    if (bVar1 == 4) {
      if (1 < *(u8 *)(param_1->script_ptr + 4)) {
        ...
        *param_1 = 2;
        ...
        FUN_80027144(*(s32 *)(param_1->sprite_ptr1 + 0x40),auStack_20,0x800,0x18);
        FUN_80074590(0xc,0,0);
        FUN_80027144(*(s32 *)(param_1->sprite_ptr1 + 0x40),auStack_20,0x800,8);
        FUN_80074590(0xc,0,0);
        FUN_80040c00(0x39);
