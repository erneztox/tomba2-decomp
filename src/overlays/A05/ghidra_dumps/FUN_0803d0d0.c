...

{
  ...
  if (*(char *)(param_1 + 6) != '\0') {
    ...
    if (DAT_800bf873 == '\0') {
      ...
      puVar7 = (ushort *)(param_1 + 0x10);
      if (((_DAT_800bfe56 & 0x20) == 0) && (DAT_800e7eaa < 0xc)) {
        bVar1 = *(byte *)(param_1 + 6);
        iVar9 = *(int *)(param_1 + 0xc);
        for (; puVar7 < (ushort *)(param_1 + (uint)bVar1 * 2 + 0x10); puVar7 = puVar7 + 1) {
          puVar5 = (uint *)(iVar9 + (uint)*puVar7 * 4);
          uVar6 = *puVar5;
          uVar4 = func_0x0013ac90(puVar5 + 1,uVar3,uVar6 & 0xff);
          func_0x0013af0c(uVar4,uVar3,uVar6 >> 0x10 & 0xff);
        }
        func_0x001351dc();
      }
      else {
        ...
        if (puVar7 < puVar8) {
          do {
            ...
            uVar6 = *puVar5;
            uVar4 = func_0x0013484c(puVar5 + 1,uVar3,uVar6 & 0xff);
            func_0x00134b74(uVar4,uVar3,uVar6 >> 0x10 & 0xff);
          } while (puVar7 < puVar8);
          halt_baddata();
        }
      }
      ...
      if (puVar7 < puVar8) {
        do {
          ...
          puVar5 = (uint *)(iVar9 + (uint)uVar2 * 4);
          uVar6 = *puVar5;
          uVar4 = func_0x0013544c(puVar5 + 1,uVar3,uVar6 & 0xffff,0);
          func_0x0013590c(uVar4,uVar3,uVar6 >> 0x10,0);
        } while (puVar7 < puVar8);
