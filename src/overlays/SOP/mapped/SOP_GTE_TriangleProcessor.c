// SOP_GTE_TriangleProcessor (SOP_GTE_TriangleProcessor) - GTE-based 3D triangle processing: transforms 9-word primitives, bounds check (0x140, 0xF0)

/* WARNING: Control flow encountered bad instruction data */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

undefined4 * SOP_GTE_TriangleProcessor(undefined4 *param_1,undefined4 param_2,int param_3)
