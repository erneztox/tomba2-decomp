...

{
  ...
  if (*(char *)(param_1 + -0x7fefa2e8) == '\x01') {
    ...
    *(undefined1 *)(iVar2 + _DAT_80105ce8 + 1) = param_4->flags;
    *(undefined1 *)(iVar2 + _DAT_80105ce8 + 2) = param_4->kind;
    *(undefined1 *)(iVar2 + _DAT_80105ce8 + 3) = param_4->sub_type;
    *(undefined1 *)(iVar2 + _DAT_80105ce8 + 4) = param_4->state;
    *(undefined1 *)(iVar2 + _DAT_80105ce8 + 5) = param_4->behavior_state;
    *(undefined1 *)(iVar2 + _DAT_80105ce8 + 7) = param_4->sub_action;
    *(undefined1 *)(iVar2 + _DAT_80105ce8 + 6) = param_4->action_state;
    *(undefined1 *)(iVar2 + _DAT_80105ce8 + 8) = param_4->counter1;
    *(undefined1 *)(iVar2 + _DAT_80105ce8 + 9) = param_4->counter2;
    *(undefined1 *)(iVar2 + _DAT_80105ce8 + 10) = param_4[10];
    *(undefined1 *)(iVar2 + _DAT_80105ce8 + 0xb) = param_4->render_flags;
    *(undefined1 *)(iVar2 + _DAT_80105ce8 + 0xc) = param_4[0xc];
    *(undefined1 *)(iVar2 + _DAT_80105ce8 + 0xd) = param_4->sprite_flags;
