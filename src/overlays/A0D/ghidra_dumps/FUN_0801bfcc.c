...
undefined4 FUN_0801bfcc(int param_1)

{
  ...
  if (bVar1 == 1) {
    ...
    *(char *)(param_1 + 6) = *(char *)(param_1 + 6) + '\x01';
    func_0x00040cdc(param_1,0,*(undefined4 *)((DAT_800bf870 - 10) * 4 + -0x7fedb228));
        ...
        if (*(char *)(param_1 + 0x70) == -1) {
          *(char *)(param_1 + 6) = *(char *)(param_1 + 6) + '\x01';
          if ((DAT_800bfa18 & 0x1f) != 0) {
            func_0x00040cdc(param_1,0,*(undefined4 *)((DAT_800bf870 - 10) * 4 + -0x7fedb0f4));
            *(undefined1 *)(param_1 + 0x70) = 1;
            uVar2 = _DAT_800e7ed6;
    ...
    *(undefined1 *)(param_1 + 6) = 1;
    func_0x00040cdc(param_1,0,0x80124d50);
    *(undefined1 *)(param_1 + 0x70) = 1;
  }
                    /* WARNING: Bad instruction - Truncating control flow here */
  halt_baddata();
