// A0G_GTE_Projection - GTE projection: screen-space coordinate calculation

/* WARNING: Control flow encountered bad instruction data */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint * A0G_GTE_Projection(uint *param_1,int param_2,int param_3)

{
  ...
  if (param_3 != 0) {
    puVar10 = param_1 + 4;
    puVar8 = g_OrderingTable + 0xc;
    do {
      iVar6 = param_3 + -1;
      setCopReg(2,in_zero,puVar11->behavior_state);
      setCopReg(2,0x800,puVar11->action_state);
      setCopReg(2,0x1800,puVar11->action_state >> 0x10);
      setCopReg(2,param_3,puVar11->sub_action);
      setCopReg(2,param_1,puVar11->counter1);
      setCopReg(2,0x2800,puVar11->counter2);
      uVar4 = *puVar11;
      ...
      if (-1 < _DAT_1f800000) {
        ...
        if (0 < _DAT_1f800000) {
          ...
          puVar9->behavior_state = uVar2;
          uVar2 = getCopReg(2,0xe);
          puVar9->counter1 = uVar2;
          setCopReg(2,in_zero,puVar11[10]);
          setCopReg(2,0x800,puVar11->counter2 >> 0x10);
