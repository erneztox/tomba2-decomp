...

{
  ...
  if ((int)sVar2 <
    ...
    _DAT_1f800014 = iVar3;
    func_0x0009c800(*(undefined4 *)(iVar3 * 4 + 0x1f80000c),
  ...
  _DAT_1f800034 = 1;
  _DAT_1f80002c = *(undefined4 *)(_DAT_1f800028 * 8 + 0x1f800018);
  iVar1 = _DAT_1f800014 * 4;
  _DAT_1f800014 = iVar3;
  func_0x00081218(&local_10,*(undefined4 *)(iVar1 + 0x1f80000c));
  return;
}
