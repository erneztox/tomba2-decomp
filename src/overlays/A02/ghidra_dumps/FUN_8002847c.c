...

{
  ...
  do {
    uVar4 = piVar6[-5];
    *(short *)(puVar5 + 1) =
         _DAT_1f80008c + (short)((uint)((char)piVar6[1] * _DAT_1f800084) >> 0x10);
    *(short *)(puVar5 + 0xd) =
         _DAT_1f80008c + (short)((uint)(*(char *)((int)piVar6 + 5) * _DAT_1f800084) >> 0x10);
    *(short *)(puVar5 + 0x19) =
         _DAT_1f80008c + (short)((uint)((char)piVar6[2] * _DAT_1f800084) >> 0x10);
    *(short *)(puVar5 + 0x25) =
    ...
    *(int *)(puVar5 + 0x29) = iVar2 >> 0x10;
    ...
    setCopReg(2,unaff_s4,param_1[3]);
    setCopReg(2,unaff_s5,param_1[4]);
    setCopReg(2,unaff_s6,param_1[5]);
    setCopReg(2,puVar5,param_1[5]);
    copFunction(2,0xf8002a);
    uVar1 = getCopReg(2,0x14);
    _DAT_800bf544[1] = uVar1;
    uVar1 = getCopReg(2,0x15);
    _DAT_800bf544[4] = uVar1;
    uVar1 = getCopReg(2,0x16);
    _DAT_800bf544[7] = uVar1;
