  ...
  if (bVar1 == 1) {
    *(undefined1 *)(param_1 + 1) = 1;
    ...
    if (*(char *)(param_1 + 0x70) == -1) {
      if (*(char *)(param_1 + 6) == '\0') {
        func_0x00040d68(param_1,0x80147ea4);
    ...
    *(undefined1 *)(param_1 + 1) = 1;
    ...
    if (*(char *)(param_1 + 6) == '\0') {
      ...
      if (*(char *)(param_1 + 0x70) == -1) {
        ...
        if (bVar1 < 2) {
          if (bVar1 == 0) {
            if (*(char *)(param_1 + 0x5f) == 'h') {
              func_0x00040d68(param_1,0x80147ef4);
              *(undefined1 *)(param_1 + 7) = 1;
                    /* WARNING: Bad instruction - Truncating control flow here */
              halt_baddata();
            }
            func_0x00040d68(param_1,0x80148004);
