...

{
  ...
  if (bVar1 == 1) {
    ...
    if (*(byte *)(param_1 + 5) < 0xb) {
                    /* WARNING: Could not emulate address calculation at 0x08020600 */
                    /* WARNING: Treating indirect jump as call */
      (**(code **)((uint)*(byte *)(param_1 + 5) * 4 + -0x7fef66b0))();
      return;
    }
    if (*(char *)(param_1 + 1) != '\0') {
    ...
    *(undefined1 *)(param_1 + 0x2b) = 0;
    ...
    if (bVar1 == 0) {
      ...
      *(undefined2 *)(param_1 + 0x36) = 0x2e36;
