// A0G_TriangleRasterizer - Triangle rasterizer: scanline fill, screen bounds

/* WARNING: Control flow encountered bad instruction data */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void A0G_TriangleRasterizer(int param_1,short *param_2,short *param_3,short *param_4)
