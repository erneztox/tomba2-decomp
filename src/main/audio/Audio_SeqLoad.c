...
#include "tomba.h"
void Audio_SeqLoad(s16 param_1,s16 param_2,u8 param_3)

{
  ...
  Audio_KeyOn((int)iVar6->flags,*(u8 *)(uVar9 + iVar6 + 0x37),local_68);
    ...
    *(u8 *)(iVar6 + 0x15) = 1;
    ...
    if (iVar6->flags == '\x02') {
      if ((iVar6->flags == '\0') && (iVar8 = 0, local_68->flags != 0)) {
        ...
        iVar7 = 0;
        do {
          Audio_VoiceSet1((int)iVar6->flags,*(u8 *)(uVar9 + iVar6 + 0x37),
                       iVar7 >> 0x10,&local_58);
          bVar2 = iVar6->flags;
          ...
          iVar8 = iVar8 + 1;
          Audio_VoiceSet2((int)iVar6->flags,*(u8 *)(uVar9 + iVar6 + 0x37),
                       iVar7 >> 0x10,&local_58);
          iVar7 = iVar7 + 0x10000;
        } while (iVar8 < (int)(uint)local_68->flags);
      }
      uVar4 = Audio_AllocVoice((int)param_1,(int)param_2);
      iVar6->flags = uVar4;
      iVar6->flags = 0;
      return;
    }
