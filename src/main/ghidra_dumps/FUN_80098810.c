...

{
  ...
  if ((bVar1) || ((uVar2 & 0x100000) != 0)) {
    *(short *)(DAT_800ac604 + 0x1e8) = (short)param_1[0xb];
  }
  ...
  if ((bVar1) || ((uVar2 & 0x1000000) != 0)) {
    *(short *)(DAT_800ac604 + 0x1f0) = (short)param_1[0xd];
  }
