...

{
  ...
  if (*(char *)(param_1 + 0x47) == '\x02') {
    ...
    _DAT_1f80002c = 0;
    _DAT_1f80003a = *(ushort *)(iVar13 + 0x3a) >> 1;
    _DAT_1f80002a = _DAT_1f80003a - 0x50;
    _DAT_1f800034 = 0;
    _DAT_1f80003c = 0;
    _DAT_1f800044 = 0;
    _DAT_1f800042 = *(ushort *)(iVar13 + 0x3a) >> 1;
    _DAT_1f800032 = _DAT_1f800042 - 0x50;
    iVar5 = 0;
  ...
  do {
    if (*(short *)(param_1 + 0x7e) != 0) {
      ...
      if ((iVar12 == -1) && (iVar11 == -0x80000000)) {
        trap(0x1800);
      }
      sVar1 = *(short *)(param_1 + 0x7e);
      iVar8 = func_0x00083e80(iVar11 / iVar12);
      if (iVar12 == 0) {
        trap(0x1c00);
      }
      if ((iVar12 == -1) && (iVar5 << 0xb == -0x80000000)) {
        trap(0x1800);
      }
      ...
      iVar7 = func_0x00083e80((iVar5 << 0xb) / iVar12);
      ...
      if (*(char *)(param_1 + 0x29) != '\0') {
        if ((*(int *)(iVar13 + 0x30) + (int)_DAT_1f80002a <= (int)_DAT_1f800162) &&
           ((int)_DAT_1f800162 < *(int *)(iVar13 + 0x30) + (int)(short)_DAT_1f80003a)) {
          if ((DAT_800e7fc7 & 1) == 0) {
