...
uint FUN_8001d08c(uint param_1,undefined4 param_2,undefined4 param_3,undefined4 *param_4)

{
  ...
  do {
    if (param_1 != 0) {
      if (param_1 != (ushort)_DAT_8003c2f8[4]) {
        *_DAT_8003c2f8 = 0;
        if (_DAT_80039e90 == 0) {
          return 0;
        }
    ...
    do {
      ...
      *puVar2 = 0x20843;
      *DAT_80026ccc = 0x1325;
      param_1 = _DAT_80039e74;
    } while (_DAT_80039e98 != 1);
  } while( true );
}
