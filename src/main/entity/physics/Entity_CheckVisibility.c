/**
 * @brief Checks if an entity is within the viewing frustum and not too far.
 *        Computes distance squared and dot product with camera direction.
 *        Returns 1 if visible, 0 if culled.
 * @note Original: func_8002B278 at 0x8002B278
 */
// Entity_CheckVisibility
...

{
  ...
  uVar2 = 0;
  if (0x1ff < uVar1) {
    // Check visibility cone via dot product
    if ((uVar1 < 0x1c01) &&
       ((int)(uVar1 * 0xd60) <=
