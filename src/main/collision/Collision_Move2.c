/**
 * @brief Collision move variant 2: reads _DAT_1f8001ec, updates position
...

{
  ...
  iVar3 = (int)(short)_DAT_1f8001ec->kind;
  if (iVar3 < 1) {
    iVar4 = (int)(short)_DAT_1f8001ec->flags;
    iVar2 = iVar4 + iVar3;
  }
  else {
    iVar2 = (int)(short)_DAT_1f8001ec->flags;
    iVar4 = iVar2 + iVar3;
  }
  if (_DAT_1f8001be <= iVar4) {
    ...
    if ((*_DAT_1f8001e0 & 8) == 0) {
      iVar3 = (int)(short)_DAT_1f8001ec->kind * ((int)_DAT_1f8001c2 - (int)(short)param_1);
      ...
      uVar1 = _DAT_1f8001ec->flags;
    }
    else {
      uVar1 = _DAT_1f8001ec->flags;
      iVar4 = (int)(short)_DAT_1f8001ec->kind * (int)_DAT_1f8001c2 >> 6;
    }
