...
#include "tomba.h"
void Entity_State_Action3(u8 *param_1)
...
LAB_8005e664:
  ...
  case 7:
    ...
    if (iVar3 == 0) {
      if (((((_g_InputState & 0x10) != 0) || (iVar3 = Entity_AnimFrame(param_1), iVar3 == 1)) ||
          (Entity_PhysicsUpdate(param_1,0), (_g_InputState & 0x10) != 0)) || ((param_1->behavior_flags & 2) == 0)) {
        param_1[0x61] = 0;
        param_1->behavior_state = 0;
        param_1->action_state = 0;
        param_1->sub_action = 0;
