...

{
  ...
  FUN_800953b0((int)*(s8*)(iVar3 + 0x26),*(u8 *)(iVar4 + 0x37),param_3);
  FUN_80095d10((int)(s16)(param_1 | param_2 << 8),(int)*(s8*)(iVar3 + 0x26),
               *(u8 *)(iVar4 + 0x37),*(s16 *)((uint)bVar1 * 2 + iVar3 + 0x60),
               *(u8 *)(iVar4 + 0x27));
  uVar2 = FUN_80090160((int)(s16)param_1,(int)param_2);
  *(s32 *)(iVar3 + 0x90) = uVar2;
  return;
}
