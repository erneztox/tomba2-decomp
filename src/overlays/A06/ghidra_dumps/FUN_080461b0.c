...

{
  ...
  while( true ) {
    ...
    local_30 = *(short *)(param_1 + 0x2c) + (short)((int)(iVar2 * (uint)bVar1 * iVar4) >> 0x14);
    local_2c = *(short *)(param_1 + 0x30) + (short)((int)(iVar3 * (uint)pbVar5[1] * iVar4) >> 0x14);
