...

{
  ...
  if (bVar1 == 1) {
    ...
    *(undefined1 *)(param_1 + 1) = 1;
    ...
    if (bVar1 == 0) {
      iVar4 = func_0x000519e0(param_1,0xf,_DAT_800ecfd0,0x80117778);
      if (iVar4 != 0) {
        return;
      }
      *(undefined4 *)(param_1 + 0x3c) = _DAT_800ecf90;
      func_0x00077c40(param_1,0x8011a738,0x10);
