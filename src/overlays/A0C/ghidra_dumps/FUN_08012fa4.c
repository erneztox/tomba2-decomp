...
void FUN_08012fa4(int param_1,int param_2)

{
  ...
  iVar4 = func_0x00083f50((int)*(short *)(iVar8 + 0xc));
  sVar1 = *(short *)(param_1 + 0x156);
  iVar5 = func_0x00083e80((int)*(short *)(iVar8 + 0xc));
  *(short *)(param_1 + 0x32) =
       (short)(iVar4 * sVar1 >> 0xc) +
       *(short *)(iVar8 + 0x30) + (short)(-(iVar5 * *(short *)(param_1 + 0x152)) >> 0xc);
  iVar4 = func_0x00083f50(*(short *)(iVar8 + 0xc) + 0x400);
  sVar1 = *(short *)(param_1 + 0x156);
  iVar5 = func_0x00083f50((int)*(short *)(iVar8 + 10));
  iVar7 = (int)(short)(iVar4 * sVar1 >> 0xc);
  iVar4 = func_0x00083e80((int)*(short *)(iVar8 + 10));
  sVar2 = *(short *)(iVar8 + 0x2c);
  sVar3 = *(short *)(iVar8 + 0x34);
  iVar8 = func_0x00083f50((int)*(short *)(iVar8 + 0xc));
  ...
  *(short *)(param_1 + 0x36) =
  ...
  ;
  iVar4 = func_0x00083e80((int)*(short *)(param_1 + 0x58));
  ...
  *(short *)(param_1 + 0x2e) = *(short *)(param_1 + 0x2e) - (short)(iVar4 * iVar8 >> 0xc);
  iVar4 = func_0x00083f50((int)*(short *)(param_1 + 0x58));
  *(short *)(param_1 + 0x32) =
