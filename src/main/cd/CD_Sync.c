/**
 * @brief CD-ROM sync: waits for CD drive to complete operation with timeout
 * @note Original: func_8008A6EC at 0x8008A6EC
 */
// CD_Sync
...
uint FUN_8008a6ec(int param_1,undefined1 *param_2)

{
  ...
  _DAT_8010274c = 0;
  _DAT_80102750 = s_CD_sync_8001c2e4;
  while( true ) {
