/**
 * @brief Submits Z-axis rotated sprite: adds GTE rotation on Z before MVMVA
 * @note Original: func_80031D24 at 0x80031D24
 */
// Entity_SubmitSpriteRotZ
...
void Entity_SubmitSpriteRotZ(s32 *param_1,u8 *param_2,int param_3)
