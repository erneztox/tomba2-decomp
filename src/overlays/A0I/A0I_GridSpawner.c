// A0I_GridSpawner - Grid entity spawner: nested loops, spawns pool 1 type 4

void A0I_GridSpawner(int param_1)
  ...
  do {
    ...
    do {
      ...
      if (iVar1 != 0) {
        ...
        *(s32 *)(iVar1 + 0x1c) = 0x8010ad64;
        iVar1->rot_y = (short)(iVar4 + 1) * 0x200 + 0x71a;
        uVar2 = Math_Random();
