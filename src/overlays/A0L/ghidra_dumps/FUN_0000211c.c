...

{
  ...
  if (bVar1 != 0) {
    ...
    for (puVar6 = (ushort *)(param_1 + 0x10); puVar6 < (ushort *)(param_1 + (uint)bVar1 * 2 + 0x10);
        puVar6 = puVar6 + 1) {
      puVar4 = (uint *)(iVar7 + (uint)*puVar6 * 4);
      uVar5 = *puVar4;
      uVar3 = func_0x0010aa4c(puVar4 + 1,uVar2,uVar5 & 0xff);
      func_0x0010ad40(uVar3,uVar2,uVar5 >> 0x10 & 0xff);
    }
  }
  return;
}
