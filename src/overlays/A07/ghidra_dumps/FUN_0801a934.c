...
void FUN_0801a934(int param_1,int param_2)

{
  ...
  *(undefined2 *)(param_1 + 8) = 0;
  pcVar4 = *(char **)(param_2 * 4 + -0x7fecde2c);
  if (*pcVar4 != -1) {
    pcVar3 = pcVar4 + 0xc;
    do {
      if ((((pcVar3[-1] != '\x01') ||
        ...
        if ((byte)pcVar3[-2] < 0x19) {
                    /* WARNING: Could not emulate address calculation at 0x0801aa24 */
                    /* WARNING: Treating indirect jump as call */
          (**(code **)((uint)(byte)pcVar3[-2] * 4 + -0x7fef6b7c))();
          return;
        }
