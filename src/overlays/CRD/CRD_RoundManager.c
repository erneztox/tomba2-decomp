...

{
  ...
  bVar1 = (*(u8 *)(param_1 + 0x21) & 8) != 0;
  if (bVar1) {
    local_60->type = 0xd1;
  }
  uVar2 = (uint)bVar1;
  if ((*(u8 *)(param_1 + 0x21) & 2) != 0) {
    local_60[uVar2] = 0x39;
    uVar2 = uVar2 + 1;
  }
  if ((*(u8 *)(param_1 + 0x21) & 1) != 0) {
    local_60[uVar2] = 0x3a;
    uVar2 = uVar2 + 1;
  }
  if ((*(u8 *)(param_1 + 0x21) & 4) != 0) {
    local_60[uVar2] = 0x3b;
    uVar2 = uVar2 + 1;
  }
  if ((*(u16 *)(param_1 + 0x24) & 0x200) != 0) {
    local_60[uVar2] = 0xd0;
    uVar2 = uVar2 + 1;
  }
  if ((param_1->prev & 0x3000) != 0) {
  ...
  if (uVar2 != 0) {
    if (-1 < iVar3) {
      ...
      do {
        ...
        local_2c = 0;
        iVar3 = iVar3 + -1;
        GPU_SpriteRender(&local_30,*(s32 *)((uVar2 & 0xfff) * 4 + -0x7ffe8ccc),_DAT_800ecf58,
                        &local_38);
      } while (-1 < iVar3);
    }
    return;
  ...
  if (param_2 != 1) {
    ...
    local_2a = 0;
    local_2c = 0;
    GPU_SpriteRender(&local_30,_DAT_80017414,_DAT_800ecf58,&local_38);
                    /* WARNING: Bad instruction - Truncating control flow here */
    halt_baddata();
  }
                    /* WARNING: Bad instruction - Truncating control flow here */
