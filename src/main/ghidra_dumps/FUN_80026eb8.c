...

{
  ...
  if (param_4 < (int)(uint)*(ushort *)(param_2 + 4)) {
    ...
    *(undefined1 *)(param_1 + 0x34) = puVar1[4];
    *(undefined1 *)(param_1 + 0x35) = puVar1[5];
    *(undefined1 *)(param_1 + 0x38) = puVar1[8];
    *(undefined1 *)(param_1 + 0x39) = puVar1[9];
    *(undefined1 *)(param_1 + 0x3c) = puVar1[0xc];
    *(undefined1 *)(param_1 + 0x3d) = puVar1[0xd];
    *(undefined2 *)(param_1 + 0x3a) = *(undefined2 *)(puVar1 + 10);
    *(undefined2 *)(param_1 + 0x36) = *(undefined2 *)(puVar1 + 6);
