...

{
  ...
  if (bVar1 == 1) {
    if (*(char *)(param_1 + 3) == '\0') {
        ...
        if (*(char *)(param_1 + 0x70) == -1) {
          if (*(char *)(param_1 + 6) == '\0') {
            ...
            *(undefined1 *)(param_1 + 0x7a) = uVar2;
            func_0x00040d68(param_1,0x80141a94);
            *(undefined1 *)(param_1 + 0x70) = 2;
      ...
      if ((*(char *)(param_1 + 1) != '\0') &&
         (func_0x0004190c(param_1), *(char *)(param_1 + 1) != '\0')) {
  ...
  if (bVar1 < 2) {
    ...
    iVar3 = func_0x000519e0(param_1,0xf,_DAT_800ecfd0,0x8013fd44);
    if (iVar3 == 0) {
