...
void FUN_0002300c(undefined1 *param_1)

{
  ...
  if (bVar1 != 1) {
    ...
    iVar3 = func_0x000519e0(param_1,3,_DAT_800ecfe8,0x8013f1b8);
    if (iVar3 != 0) {
      return;
    }
    *(undefined4 *)(param_1 + 0x3c) = _DAT_800ecfec;
    ...
    func_0x0012bbdc(param_1,1,0x24);
