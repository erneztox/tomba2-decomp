/**
 * @brief Submits rotated sprite to OT: GTE matrix from 3-byte rotation + MVMVA transform
...
void FUN_800318a0(undefined4 *param_1,byte *param_2,undefined4 param_3)
