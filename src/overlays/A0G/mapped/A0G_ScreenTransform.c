// A0G_ScreenTransform - Screen-space coordinate transform with sin/cos

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void A0G_ScreenTransform(int param_1)

{
  ...
  uVar7 = -_DAT_800a3f94 - (int)_DAT_1f8000f2 & 0xfff;
  ...
  *(undefined1 *)(param_1 + 6) = 0;
  func_0x0010ccdc(param_1,&local_30,&local_28,&local_20);
  return;
}
