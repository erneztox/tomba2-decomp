/**
 * @brief Entity door behavior variant 2: entity[4]=1, transition
...

{
  ...
  if (bVar1 != 1) {
    ...
    *(ushort *)(param_1 + 0x4c) = (ushort)*(byte *)(param_1 + 0x2a) << 6;
    *(undefined2 *)(param_1 + 0x70) = 0;
    iVar3 = (uint)*(byte *)(param_1 + 0x2a) * 4;
    *(short *)(param_1 + 0x62) = (short)(char)(&DAT_800a49e0)[iVar3];
    *(short *)(param_1 + 0x68) = (short)(char)(&DAT_800a49e1)[iVar3];
    ...
    *(ushort *)(param_1 + 0x6e) =
    ...
    iVar3 = FUN_80083f50();
    *(short *)(param_1 + 0x60) = (short)((uint)(iVar3 * 3) >> 0xb);
    iVar3 = FUN_80083e80((int)*(short *)(param_1 + 0x6e));
    *(short *)(param_1 + 100) = (short)(iVar3 * -6 >> 0xc);
    return;
  }
  *(undefined1 *)(param_1 + 1) = 1;
  FUN_80068610(param_1,(short *)(param_1 + 0x60));
  if (*(char *)(param_1 + 5) == '\0') {
    sVar2 = *(short *)(param_1 + 0x62) + 1;
    *(short *)(param_1 + 0x62) = sVar2;
    if (8 < sVar2) {
      *(undefined2 *)(param_1 + 0x62) = 8;
    }
    sVar2 = *(short *)(param_1 + 0x2e) + *(short *)(param_1 + 0x62);
    *(short *)(param_1 + 0x2e) = sVar2;
    if ((_DAT_1f800162 + -0x8c < (int)sVar2) &&
       (sVar2 = *(short *)(param_1 + 0x68), *(short *)(param_1 + 0x68) = sVar2 + -1, sVar2 == 1)) {
      *(char *)(param_1 + 5) = *(char *)(param_1 + 5) + '\x01';
      *(short *)(param_1 + 0x72) = _DAT_1f800162 - *(short *)(param_1 + 0x2e);
    }
    if (*(short *)(param_1 + 0x62) < 0) {
      *(short *)(param_1 + 0x2c) = *(short *)(param_1 + 0x2c) + *(short *)(param_1 + 0x60);
...
LAB_800688bc:
    if (*(short *)(param_1 + 0x62) < 0) goto LAB_800689e8;
  }
  iVar5 = (int)(((uint)*(ushort *)(param_1 + 0x30) - (uint)_DAT_1f800164) * 0x10000) >> 0x10;
  iVar3 = (int)(((uint)*(ushort *)(param_1 + 0x2c) - (uint)_DAT_1f800160) * 0x10000) >> 0x10;
  ...
  *(ushort *)(param_1 + 0x2c) = _DAT_1f800160 + (short)(iVar3 * iVar6 >> 0xc);
  ...
  if (*(char *)(param_1 + 5) == '\x01') {
    *(short *)(param_1 + 0x4a) = *(short *)(param_1 + 0x4a) + 0x40;
    if ((*(byte *)(param_1 + 0x2a) & 1) == 0) {
      ...
      sVar2 = *(short *)(param_1 + 0x72) + _DAT_800e7efc * -2;
    }
    iVar3 = FUN_80083e80((int)*(short *)(param_1 + 0x6a));
    *(short *)(param_1 + 0x2e) = _DAT_1f800162 + sVar2 + (short)(iVar3 >> 6);
    *(ushort *)(param_1 + 0x6a) =
         *(short *)(param_1 + 0x6a) + (*(short *)(param_1 + 0x6c) >> 3) & 0xfff;
  }
  return;
}
