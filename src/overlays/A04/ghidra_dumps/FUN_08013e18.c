...
/* WARNING: Removing unreachable block (ram,0x080140b8) */
/* WARNING: Removing unreachable block (ram,0x08014188) */
/* WARNING: Removing unreachable block (ram,0x080141c0) */
/* WARNING: Removing unreachable block (ram,0x080141e8) */
/* WARNING: Removing unreachable block (ram,0x080140e4) */
/* WARNING: Removing unreachable block (ram,0x08014110) */
/* WARNING: Removing unreachable block (ram,0x08014124) */
/* WARNING: Removing unreachable block (ram,0x0010d248) */

void FUN_08013e18(int param_1,int param_2,int param_3)
      ...
      if (bVar8 == 1) {
        ...
        if (bVar8 < 2) {
          ...
          if (iVar4 <= iVar3) {
            ...
            *(short *)(param_1 + 0x36) =
                 (*(short *)(param_3 + 0x34) + -0x60) - *(short *)(param_1 + 0x80);
            return;
          }
          if (iVar3 + 0x60 <
