...
void FUN_80126e34(undefined4 param_1,undefined4 param_2,undefined2 param_3)

{
  ...
  *(ushort *)(*(int *)(unaff_s0 + *(short *)(unaff_s0 + 0x6c) * 4 + 0xc0) + 0xc) =
       *(ushort *)(*(int *)(unaff_s0 + *(short *)(unaff_s0 + 0x6c) * 4 + 0xc0) + 0xc) & 0xfff;
  iVar8 = (uint)(byte)unaff_s0[0x46] << 4;
  uVar3 = func_0x80077768(iVar8,(int)*(short *)(*(int *)(unaff_s0 +
                                                        *(short *)(unaff_s0 + 0x6c) * 4 + 0xc0) + 10
                                               ));
  unaff_s0[0x46] = uVar3;
  if ((unaff_s0[0x47] & 0x80) != 0) {
    *(undefined2 *)(*(int *)(unaff_s0 + *(short *)(unaff_s0 + 0x6c) * 4 + 0xc0) + 0x14) = 0x380;
    *(undefined2 *)(*(int *)(unaff_s0 + 0xc4) + 0x12) = 0xe;
    FUN_8012fe94();
    return;
  }
  ...
  *(undefined2 *)(unaff_s0 + 0x74) = 1;
  ...
  if (unaff_s0[0x46] != '\0') {
    unaff_s0[0x5e] = 3;
    sVar4 = *(short *)(*(int *)(unaff_s0 + *(short *)(unaff_s0 + 0x6c) * 4 + 0xc0) + 0xc) + 0x800;
    *(short *)(unaff_s0 + 0x6e) = sVar4;
    unaff_s0[5] = (char)sVar4 + (char)iVar8;
    *(undefined2 *)(unaff_s0 + 0xb8) = 3;
    *(undefined2 *)(unaff_s0 + 0xba) = param_3;
    *(undefined2 *)(unaff_s0 + 0xbc) = *(undefined2 *)(unaff_s0 + 100);
    func_0x80042354();
    puVar9 = unaff_s0;
    uVar5 = func_0x80040cdc();
    unaff_s0[0x70] = unaff_s1;
    iVar8 = (extraout_v1 & 0xfff) - 0xc00;
    if (iVar8 < 0) {
      iVar8 = -iVar8;
    }
    *(undefined2 *)(unaff_s0 + 0x4e) = uVar5;
    *(short *)(unaff_s0 + 0x4e) = (short)(puVar9 + (0x400 - iVar8 >> 6) * -0x100);
    if ((int)(puVar9 + (0x400 - iVar8 >> 6) * -0x100) * 0x10000 < 1) {
  ...
  *(short *)(*(int *)(unaff_s0 + *(short *)(unaff_s0 + 0x6c) * 4 + 0xc0) + 0x14) =
  ...
  if ((bVar1 & 0x10) == 0) {
    if (((int)*(short *)(unaff_s0 + 0x62) & 0xff00U) != 0xff00) {
      ...
      if (uVar7 < 5) {
        func_0x8004cbd8();
        iVar8 = *(int *)(unaff_s0 + *(short *)(unaff_s0 + 0x6c) * 4 + 0xc0);
          ...
          if (iVar8 == 0) {
            ...
            *(undefined2 *)(unaff_s0 + 0x5a) = *(undefined2 *)(unaff_s0 + 0x56);
            ...
            if (*(char *)((byte)unaff_s0[3] + 0x8014a9b0) != '\0') {
              ...
              sVar4 = *psVar6;
              if (*psVar6 != 0) {
                *(short *)(unaff_s0 + 0x60) = sVar4 - *(short *)(unaff_s0 + 0x2e);
                FUN_801390d8();
                return;
              }
              *(short *)(unaff_s0 + 0x60) = sVar4;
              sVar4 = *(short *)((uint)(byte)unaff_s0[3] * 0xc + -0x7feb5644);
              if (*(short *)((uint)(byte)unaff_s0[3] * 0xc + -0x7feb5644) != 0) {
                *(short *)(unaff_s0 + 100) = sVar4 - *(short *)(unaff_s0 + 0x36);
                FUN_8013911c();
                return;
              }
              *(short *)(unaff_s0 + 100) = sVar4;
              ...
              *(undefined2 *)(unaff_s0 + 0x62) = *(undefined2 *)(uVar7 * 0xc + -0x7feb5646);
              ...
              uVar2 = *(ushort *)(uVar7 * 0xc + -0x7feb5640);
              *(ushort *)(unaff_s0 + 0x82) = uVar2;
              iVar8 = (uint)uVar2 << 0x10;
              *(short *)(unaff_s0 + 0x80) = (short)((iVar8 >> 0x10) - (iVar8 >> 0x1f) >> 1);
              uVar2 = *(ushort *)((uint)(byte)unaff_s0[3] * 0xc + -0x7feb563e);
              *unaff_s0 = 1;
              *(ushort *)(unaff_s0 + 0x86) = uVar2;
              iVar8 = (uint)uVar2 << 0x10;
              *(short *)(unaff_s0 + 0x84) = (short)((iVar8 >> 0x10) - (iVar8 >> 0x1f) >> 1);
            }
