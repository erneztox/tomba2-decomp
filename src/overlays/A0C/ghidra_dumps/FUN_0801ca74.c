...
void FUN_0801ca74(undefined1 *param_1)
  ...
  if (bVar1 == 1) {
    ...
    *(short *)(param_1 + 0x56) = *(short *)(param_1 + 0x56) + 0x40;
    ...
    if (1 < bVar1) {
      if (bVar1 == 2) {
        if ((byte)param_1[5] < 6) {
                    /* WARNING: Could not emulate address calculation at 0x0801cbec */
                    /* WARNING: Treating indirect jump as call */
          (**(code **)((uint)(byte)param_1[5] * 4 + -0x7fef6db8))();
          return;
        }
      }
      else {
    ...
    if (bVar1 == 0) {
      iVar2 = func_0x000519e0(param_1,5,
                              *(undefined4 *)
                               (*(int *)((DAT_800bf870 - 10) * 4 + -0x7feda294) * 4 + -0x7ff130a8),
                              0x801259fc);
      if (iVar2 != 0) {
        return;
      }
      *(undefined4 *)(param_1 + 0x3c) =
           *(undefined4 *)(*(int *)((DAT_800bf870 - 10) * 4 + -0x7feda280) * 4 + -0x7ff130a8);
