...
undefined4 FUN_08018e28(int param_1,int param_2,short param_3,int param_4)

{
  ...
  iVar3 = (int)(((uint)*(ushort *)(param_1 + 0x2e) - (uint)*(ushort *)(param_2 + 0x2c)) * 0x10000)
          >> 0x10;
  iVar2 = (int)(((uint)*(ushort *)(param_1 + 0x36) - (uint)*(ushort *)(param_2 + 0x34)) * 0x10000)
          >> 0x10;
  ...
  if (((int)(uVar1 & 0xffff) <= (int)*(short *)(param_1 + 0x80) + (int)param_3) &&
     ((int)(((uint)*(ushort *)(param_1 + 0x32) - (uint)*(ushort *)(param_2 + 0x30)) +
            (uint)*(ushort *)(param_1 + 0x84) + param_4 & 0xffff) <=
      (int)*(short *)(param_1 + 0x86) + ((param_4 << 0x10) >> 0xf))) {
