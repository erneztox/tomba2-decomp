...
undefined4 FUN_80108e7c(int param_1,int param_2,int param_3)

{
  ...
  uVar4 = func_0x80084080(iVar5 * iVar5 + iVar6 * iVar6);
  uVar7 = 0;
  if ((int)(uint)uVar4 <= (int)*(short *)(param_1 + 0x80) + (int)*(short *)(param_2 + 0x80)) {
    ...
    if ((iVar6 < iVar5) || (iVar6 < 3)) {
      ...
      *(short *)(param_1 + 0x36) =
      ...
      cVar3 = func_0x80077768((int)_DAT_1f80009c,(int)*(short *)(param_1 + 0x140),1);
      ...
      if (iVar5 < 1) {
        ...
        if ((*(byte *)(param_1 + 0x145) & 1) == 0) {
          *(int *)(param_1 + 0x30) = (*(int *)(param_3 + 0x30) + iVar5) * 0x10000;
          func_0x80022c78();
          if (((*(ushort *)(param_2 + 0x60) & 2) != 0) && ((short)uVar4 < 0x51)) {
            _DAT_1f80018e = 1;
            _DAT_1f800188 = *(undefined2 *)(param_3 + 0x2c);
            _DAT_1f80018a = *(undefined2 *)(param_3 + 0x34);
            _DAT_1f80018c = *(short *)(*(int *)(param_2 + 0xc4) + 10) + 0x400U & 0xfff;
