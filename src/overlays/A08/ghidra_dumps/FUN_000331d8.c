...
undefined4 FUN_000331d8(int param_1)

{
  ...
  if (bVar1 < 2) {
    if (bVar1 == 0) {
      ...
      func_0x000440e4(&DAT_800e7e80,&DAT_000080b4,4);
                    /* WARNING: Bad instruction - Truncating control flow here */
      halt_baddata();
    }
  }
    ...
    *(short *)(param_1 + 0x72) = sVar4;
    if (sVar4 < 7) goto LAB_00033340;
    *(char *)(param_1 + 0x78) = *(char *)(param_1 + 0x78) + '\x01';
  }
  else if (bVar1 == 3) {
    if (*(char *)(param_1 + 0x79) == '\x01') {
      FUN_000312d4(0x91a,_DAT_800bf844 + 0x2c,0xfffffff6);
